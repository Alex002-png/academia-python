...
| **Versión / Estado** | **0.1.0-draft** · Paso 1 del flujo institucional de 9 pasos (diseño del syllabus) completo — investigación real verificada por WebSearch, 2 decisiones de diseño explícitas confirmadas (representación de M4/M5), definición concreta del capstone. **Pendiente:** revisión del Director antes de iniciar Paso 2 (construcción de `LEVEL12` en `index.html`) |
