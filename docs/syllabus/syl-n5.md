...
| **Versión / Estado** | **0.2.0** · Paso 1 (diseño) completo + **M1 · Redes desde cero completo** (4 temas, 12 días, 56 ejercicios+retos+desafíos verificados) — pendiente M2-M4, capstone, compuertas, auditorías y v1.0.0-candidato |
