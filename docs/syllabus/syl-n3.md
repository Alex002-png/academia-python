...
| **Versión / Estado** | **0.7.0-draft** · Documento de Diseño + M1+M2+M3+M4 completos (24/24 temas) + Capstone ET3 completo — primer paso del flujo institucional de 9 pasos (DOC-03 §8bis / EVT-022), pendiente: compuertas, docs de investigación, auditoría integral, Herencias Declaradas finales, auditoría adversarial y v1.0.0 |
