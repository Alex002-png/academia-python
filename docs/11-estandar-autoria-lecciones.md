...
| **Versión / Estado** | **1.1.0** · ✅ **Aprobado** por el Director (2026-07-19) — **estándar oficial de autoría de todas las lecciones futuras de la Academia**, con el registro de observaciones de ejecución (§6) institucionalizado tras la aprobación de la primera lección real |
