...
| **2.0.0** | 2026-07-20 | **MAJOR normativa, ordenada por el Director tras la Auditoría Integral de N1 (acta EVT-044):** **DP-17 · Velocidad como señal de riesgo** incorporado a §8.4, conforme al procedimiento de 8.7 (añadir un principio es MAJOR por definición). Formaliza como regla institucional permanente, no dependiente de la intuición, el hallazgo empírico de que los 8 hallazgos críticos de la Auditoría Integral de N1 convergieron en la sección construida más rápido del nivel (M6, M7, vínculo Git↔Capstone): toda unidad de N2–N12 construida significativamente más rápido que sus comparables activa automáticamente una auditoría más profunda antes de congelarse. Re-auditoría de documentos citantes exigida por 8.7: **alcance vacío** — DP-17 es de creación nueva, ningún documento aprobado lo cita todavía; no contradice ni exige cambio en DP-01…DP-16 ni en ningún ADR existente. Sin cambio de estructura documental. | **MAJOR 2.0.0** · DP-17 vigente. |
...
#### DP-17 — Velocidad como señal de riesgo
- **Enunciado:** una unidad construida significativamente más rápido que las unidades comparables que la precedieron no se presume correcta por el solo hecho de superar las verificaciones automáticas: esa velocidad inusual activa, por sí sola y de forma automática, una auditoría más profunda antes de que la unidad pueda considerarse terminada. La velocidad es una señal a investigar, nunca un logro a certificar sin más — y esta activación no depende de la intuición del Comité ni del Tutor, es una regla ejecutable (DP-10).
- **Derivación:** hallazgo empírico de la Auditoría Integral de N1 (`docs/informes/n1-auditoria-integral.md`, 2026-07-20): de los 8 hallazgos críticos, prácticamente todos convergieron en la sección construida más rápido de todo el nivel (M6, M7 y el vínculo Git↔Capstone); instrucción explícita del Director de convertir esa observación en regla institucional permanente para N2–N12, no dependiente de la intuición; DP-05 (evidencia sobre intuición pedagógica); DP-10 (toda regla debe ser ejecutable).
- **Aplicación:** al cerrar cualquier módulo de N2–N12, el Comité compara su ritmo de construcción contra los módulos ya cerrados del mismo nivel; si es notablemente menor sin justificación declarada (p. ej. reutilización explícita de infraestructura ya aprobada, como la modalidad Proyecto reutilizando DOC-07/DOC-12), esa diferencia dispara antes de congelar la unidad una revisión adversarial dedicada, equivalente en foco —aunque no necesariamente en escala— a la Auditoría Integral de N1.
- **Violación:** congelar una unidad construida en una fracción del tiempo habitual apoyándose solo en que "pasó las verificaciones automáticas", sin una revisión adicional dirigida específicamente a su rigor, densidad e integración.
...
| **DOC-07** | Especificación de la Plataforma *(primera pieza congelada: arquitectura de modalidades de contenido del Campus — cómo conviven lecciones Pyodide y laboratorios de entorno real DOC-12 sin duplicar el motor; implementada en `index.html` (EVT-035), auditada en UX y corregida (EVT-036); el resto del alcance de DOC-07 —infraestructura, S5, QAs de §21— sigue pendiente)* | T1 | §12/S5, §21, QAs aplicables | 🔒 Pieza de modalidades **congelada** (2026-07-20) — `docs/07-arquitectura-modalidades-campus-PROPUESTA.md`; auditoría UX `docs/informes/ux-auditoria-modalidades-campus.md`; resto de DOC-07 ⏳ Pendiente |
...
| **DOC-10** | Plan Maestro del Currículo (PMC) *(incorporado en la MINOR 1.1.0; la carrera completa: desglose modular N0–N12, proyectos, capstones, bibliografía y trazabilidad curricular — los SYL-Nx instancian desde él)* | T1 | §13/§14 + DOC-01 (MINOR 1.1.0, EVT-020) | ✅ Aprobado v1.0.3 (2026-07-18; PATCH 2026-07-21 ×2 — EVT-065/EVT-077) — `docs/10-plan-maestro-curriculo.md` · **plan de estudios oficial; cierre de la construcción institucional (EVT-021)** |
...
| **DOC-11** | Estándar de Autoría de Lecciones *(el molde operativo entre DOC-03/SYL-Nx y el texto real de cada lección; 8 bloques con principio + condición de cumplimiento verificable por bloque; desde v2.0.0, Estándar de Excelencia Mundial — 7 capacidades de dominio, laboratorios como mini-proyecto, Recursos recomendados obligatorios)* | T1 | DOC-03 §7bis/§16.7 (DOC-00) | ✅ Aprobado **v2.0.0** (2026-07-19) — `docs/11-estandar-autoria-lecciones.md` |
| **DOC-12** | Estándar de Laboratorios de Entorno Real *(documento hermano de DOC-11: mismo molde operativo de DOC-03/SYL-Nx, pero para contenido que ocurre fuera del navegador — terminal, Git/GitHub, entornos virtuales, Linux, Docker, APIs reales, CI/CD; 13 secciones obligatorias con principio + condición de cumplimiento verificable cada una, aprobado tras auditoría adversarial explícita sobre 9 criterios del Director)* | T1 | DOC-03 + instrucción directa del Director (2026-07-20) | ✅ Aprobado **v1.0.0** (2026-07-20) — `docs/12-estandar-laboratorios-entorno-real.md` |
| **SYL-N3** | Syllabus de N3 · Matemáticas para IA | T2 | 14.8.3, DOC-01, DOC-10 | 🟡 v1.0.0-candidato (EVT-076) — flujo de 9 pasos completo, 0 reservas abiertas; pendiente veredicto del Director |
| **SYL-N4…SYL-N12** | Syllabus por nivel (9 documentos) | T2 | 14.8.3, DOC-01, DOC-10 | ⏳ Pendientes |
...
| **EVT-027** | 2026-07-19 | Contenido / cierre de nivel | **Mayor** | **N0 · Validación congelado como versión de desarrollo — primer nivel completo de la Academia bajo DOC-11.** Las 8 lecciones (T1–T8) construidas con el flujo de 7 fases, superaron su auditoría integral longitudinal (coherencia, sin redundancia significativa, cobertura de competencias, progresión cognitiva óptima) y su Informe Final de Nivel (`docs/informes/n0-informe-final-de-nivel.md`), primer caso de esta nueva práctica institucional (DOC-11 §6ter). 5 hipótesis quedan registradas como pendientes de validación, sin bloquear N1. Toda modificación futura de N0 depende exclusivamente de evidencia real de estudiantes. Comienza la investigación de N1. | DOC-11; N0 completo; informe final |
...
| **EVT-041** | 2026-07-20 | Documento + Implementación / modalidad ligera | **Mayor** | **Modalidad `proyecto` diseñada y construida — Capstone ET1 completo, cierre de todo el contenido regular de N1.** A diferencia de DOC-07/DOC-12 (decisiones estructurales con ciclo completo de arquitectura + auditoría UX), el Director clasificó esta como decisión de implementación: documento breve (`docs/07bis-modalidad-proyecto-DISENO-LIGERO.md`, 6 preguntas fijas, sin arquitectura nueva) apoyado enteramente en la infraestructura ya congelada — mismo contrato de tres funciones del registro de modalidades, mismo almacén `S.ph[id]`, mismos primitivos visuales. Deliberadamente NO reutiliza las 13 secciones de DOC-12: un proyecto es hitos de producto, no pasos de laboratorio. Capstone construido con 5 hitos (propuesta → esqueleto → integración M6+M7 → cambio de requisitos real → cierre), reutilizando el patrón ya validado de los problemas de largo aliento B-M1...B-M7 (Blueprint §6) y el checklist de síntesis de 7 módulos que el propio Blueprint ya definía. Identidad de producto (nombre/pitch/usuario imaginable elegido por el estudiante) reemplaza el título genérico una vez capturado — diseñado explícitamente para no sentirse como lista de tareas. Verificado con el mismo arnés de Node: sintaxis limpia, 64 temas en `LEVEL1` sin duplicados, desbloqueo progresivo de hitos confirmado (bloqueado→disponible en cadena), `dayDone`/"Capstone completo" solo tras los 5 hitos, cero fugas de datos. **N1 tiene ahora todo su contenido regular y su capstone construidos; queda solo la auditoría integral y el Informe Final de Nivel para cerrar el nivel por completo.** | DOC-07; DOC-12; EVT-040; `docs/07bis-modalidad-proyecto-DISENO-LIGERO.md` |
| **EVT-043** | 2026-07-20 | Contenido / cierre de nivel | **Mayor** | **N1 · Computer Science congelado como versión de desarrollo v1.0 — primer nivel de la Academia auditado por un comité adversarial independiente antes de su cierre, no solo verificado técnicamente.** Los 7 módulos regulares (M1-M7), el Laboratorio 12 de integración, y el Capstone ET1 (modalidad `proyecto`) forman el corpus, construido bajo DOC-11/DOC-12 ya estabilizados (EVT-034/036) y corregido tras la auditoría integral (EVT-042). El Informe Final de Nivel (`docs/informes/n1-informe-final-de-nivel.md`) documenta el hallazgo institucional más importante de este nivel: los 8 defectos críticos se concentraron casi en su totalidad en el tramo construido más rápido (M6, M7, vínculo Git↔Capstone) — se institucionaliza la regla de que la velocidad de construcción es, por sí misma, una señal de riesgo a vigilar desde N2 en adelante. 4 riesgos pedagógicos quedan registrados como pendientes de validación (monotonía estructural de M1, densidad de laboratorios compactos, transferencia de depuración real, marco de H-06) — ninguno bloquea N2. **Comienza la reconstrucción de N2.** | DOC-11; DOC-12; EVT-042; `docs/informes/n1-informe-final-de-nivel.md`; `docs/informes/n1-auditoria-integral.md` |
| **EVT-077** | 2026-07-21 | Documento / PATCH autorizado | **Menor** | **DOC-10 v1.0.3 — PATCH administrativo autorizado directamente por el Director, corrigiendo la "Carga estimada" de N3 §6 de "~3 meses · ~300h" a "~4,6 meses · ~20 semanas".** El Director preguntó por la calibración real de los "días" de N3 al ver el mapa de niveles en la interfaz; se le informó del hallazgo ya documentado en la Auditoría Integral (EVT-074, `docs/informes/n3-auditoria-integral.md`) — SYL-N3 §1/§3.8 ya había revisado honestamente esta cifra al construir el contenido real (la densidad ampliada de M1-M3, justificada en investigación real de práctica distribuida — Rohrer & Taylor 2007; Rohrer, Dedrick & Stershic 2015 —, sube la duración real ~53% frente a la estimación de diseño original), pero ese ajuste nunca se había propagado al documento madre, declarado explícitamente como hallazgo pendiente de decisión del Director en 3 de los 4 informes de auditoría (no autocorregido en su momento por ser DOC-10 un documento Tier T1 ya sellado). El Director autorizó el PATCH al ser consultado ("sí, actualízalo"). **El alcance temático de N3 no cambia; solo se corrige su duración estimada para reflejar la realidad ya construida y verificada.** Referencias cruzadas actualizadas en `docs/syllabus/syl-n3.md` (§0, "Depende de") y `docs/informes/n3-auditoria-integral.md` (hallazgo #10, ahora corregido). | DOC-10 v1.0.3 §6; SYL-N3 §1, §3.8; EVT-074; `docs/10-plan-maestro-curriculo.md` |
| **EVT-076** | 2026-07-21 | Contenido / resolución de reservas | **Mayor** | **N3 — las 2 reservas del Paso 9b resueltas por instrucción directa del Director ("resuelve, y súbelo"), tras el veredicto inicial del comité adversarial (EVT-075).** **Reserva 1 (pistas que regalan la solución):** 132 ejercicios reales identificados (starter con blanco real de implementación Y primer hint ya literal) reescritos progresivamente — un hint conceptual específico antepuesto a cada uno, sin tocar `check()`/`starter`/`d`/`t`, sin tocar `retoFinal` (ya verificados como correctos) ni ejercicios de tipo "código completo, ejecuta y observa". **Ejecutado con 8 agentes independientes en worktrees de git aislados** (uno por porción de módulo: M1.T1-T4, M1.T5-T7, M2.T1-T3, M2.T4-T6, M3.T1-T3, M3.T4-T6, M4.T1-T3, M4.T4-T5) — la primera vez que este proyecto usa aislamiento de worktree para editar el MISMO archivo en paralelo sin riesgo de que un agente sobrescriba a otro; las 8 ramas se fusionaron secuencialmente sin un solo conflicto real (0 de 8 merges), confirmando que el reparto por temas produjo rangos de líneas genuinamente disjuntos. Total: 58 en M1, 21 en M2, 18 en M3, 35 en M4 (132 exactos, coincidiendo con la suma reportada por los 8 agentes). **Reserva 2 (estándares narrativos sin ruta de renderizado):** resuelta con la opción "disciplina de prosa" que el propio Paso 9b había dejado abierta (en vez de un campo de datos estructurado nuevo, más invasivo sobre el motor de renderizado compartido con N0-N2) — "el quiebre de intuición" añadido al título de la tema donde ocurre por módulo (M1.T3, M2.T4, M3.T1, M4.T5), y los 4 estándares restantes (idea universal, lo que deja de sorprender, limitación humana que compensa, el supuesto que destruye) añadidos a la prosa de `intro` de los 4 cierres reales de módulo (`n3m1t7c`, `n3m2t6c`, `n3m3t6c`, `n3m4t5b`), usando el texto ya diseñado en SYL-N3 §5 casi verbatim, no contenido inventado. Verificado tras ambas resoluciones: `node --check` limpio (array `LEVEL3` aislado y bloque `<script>` completo); los 4 harnesses de módulo confirman 0 regresiones (M1 85/85, M2 72/72, M3 72/72, M4 55/55 — idéntico a antes de las ediciones, ya que solo se tocaron `hints`/`t`/`intro`, nunca `check()`); 895 ids en todo el Campus, 0 duplicados. **SYL-N3 queda candidato a v1.0.0 sin ninguna reserva abierta** — pendiente exclusivamente del veredicto formal del Director. | SYL-N3 §9, §10; EVT-074; EVT-075; `docs/informes/n3-auditoria-integral.md` (síntesis actualizada) |
| **EVT-075** | 2026-07-21 | Documento / cierre de nivel | **Mayor** | **N3 · Matemáticas para IA — Informe Final de Nivel y Paso 9 completos (`docs/informes/n3-informe-final-de-nivel.md`; SYL-N3 §9/§10).** El Director pidió continuar con lo pendiente. **Informe Final de Nivel** con la misma estructura de 10 secciones que N1/N2 (objetivo global, competencias, habilidades técnicas/profesionales, proyectos, principios pedagógicos, riesgos abiertos, decisiones de diseño, lecciones aprendidas, recomendaciones para N4) y una congelación de contenido declarada: N3 queda como versión de desarrollo v1.0 de contenido. **Paso 9a (§9):** Herencias Declaradas hacia N4 consolidadas contra el contenido REAL (no el plan) — H-N4-01…05 verificadas, H-N4-04 corregida (ya no describe N4.M3 como "clasificadores probabilísticos"), y una herencia nueva no planeada desde el diseño original: **H-N4-06**, la convención de notación no es universal ni entre fuentes oficiales — confirmado independientemente en PyTorch y scikit-learn (hallazgo de EVT-073) más el propio cierre de σ del nivel (M4.T5) — cero prerrequisitos ocultos encontrados contra la descripción real de N4 en DOC-10 §7. **Paso 9b (§10):** auditoría adversarial con mandato de demostrar que N3 no debería existir — 6 ataques (100% Pyodide, M4 secuencial, fusión con N2/N4, cobertura de competencias, el aparato de 5 estándares, vacíos frente a un currículo de referencia); la arquitectura resiste en todas sus fronteras y decisiones de plataforma; 2 hallazgos reales aplicados con costo mínimo — estabilidad numérica nombrada como principio unificador conectando los hallazgos de M1.T5 y M3.T3 (§3.3, extendido); mención Beyond the Curriculum de SVD como alternativa real a la eigendescomposición de PCA (ficha de M1.T7, §5), sin nuevo contenido. **Veredicto explícitamente distinto al de SYL-N2** ("candidato a v1.0.0 sin reservas"): SYL-N3 queda **candidato a v1.0.0 CON 2 reservas nombradas y acotadas** — el patrón de pistas que regalan la solución (79-92% de ~285 ejercicios, tercera vez consecutiva sin corregirse tras N1/N2) y la ausencia de ruta de renderizado para los 5 estándares narrativos (sustancia presente, señalamiento ausente) — ninguna bloquea que un estudiante complete N3 preparado para N4, pero ambas requieren decisión explícita del Director, no silencio indefinido. Sigue: veredicto definitivo del Director para la publicación de SYL-N3 v1.0.0. | SYL-N3 §7, §9, §10; DOC-10 §7; EVT-074; `docs/informes/n1-informe-final-de-nivel.md`, `n2-informe-final-de-nivel.md` (formato precedente); `docs/informes/n3-informe-final-de-nivel.md` |
| **EVT-074** | 2026-07-21 | Auditoría / cierre de nivel | **Mayor** | **Auditoría Integral de N3 ejecutada — 4 auditores independientes, sin coordinación entre sí, mismo método que la auditoría de N2.** El Director pidió continuar con lo pendiente. Documentada en `docs/informes/n3-auditoria-integral.md`. **Hallazgo convergente principal (encontrado por los 4 auditores independientemente, con conteos casi idénticos):** M2.T4 (descenso de gradiente, la competencia que "mapea directo" a C-N3-02) tenía 8 ejercicios contra 10 de sus hermanos de módulo — corregido añadiendo 2 ejercicios reales y verificados (`n3m2t4e9`: tasa de aprendizaje pequeña converge pero muy lento; `n3m2t4e10`: curvatura distinta por dimensión, sembrando la motivación real de tasas adaptativas de N4+). **Segundo hallazgo convergente, documentado sin resolver de raíz por decisión explícita de alcance:** las pistas de ejercicios regulares regalan la solución completa en 79-92% de ~285 ejercicios (estimado independientemente por 3 de los 4 auditores) — tercera vez consecutiva que este patrón se documenta (tras N1 y N2), ahora a su mayor escala; se decidió NO reescribir ~285 pistas bajo la presión de esta auditoría (riesgo real de introducir errores nuevos) y en su lugar documentarlo como el hallazgo más importante pendiente, con recomendación de institucionalizarlo como regla verificable de DOC-11 antes de N4. **Hallazgo específico de lente narrativo:** los 5 "estándares" pedagógicos que SYL-N3 §5 diseña para cada módulo (quiebre de intuición, supuesto que destruye, idea universal, lo que deja de sorprender, limitación humana que compensa) tienen 0 apariciones verificadas en `index.html` — sin ruta de renderizado para modalidad Pyodide (a diferencia de N2, que sí hizo visible su "Momento Fundacional" en títulos/etiquetas) — la sustancia pedagógica está genuinamente presente, falta el señalamiento explícito; queda como decisión de diseño pendiente. **6 correcciones adicionales aplicadas durante la auditoría**, todas de bajo riesgo: título+intro de `n3m2t4c` (afirmaba falsamente "cierra T4 y M2"); contradicción §4/§5 sobre dependencia M3→M2 (T6 sí depende de M2.T6); mención inexistente de "el jacobiano" en §4; estadísticas del Apéndice E de este mismo Blueprint (62/54/8→73/61/12, desactualizadas en 11 hitos); marcador "pendiente: docs de investigación" obsoleto en SYL-N3 §0 (sobrevivió a su propia resolución en EVT-073); H-N4-04 corregida (describía N4.M3 como "clasificadores probabilísticos", cuando DOC-10 §6 real dice "ML clásico aplicado — árboles/SVM/ensembles/clustering"). **Decisión deliberada de NO editar DOC-10 §6** pese a que 3 de los 4 auditores señalaron que su tabla de duración no refleja la revisión honesta ya declarada en SYL-N3 §1 (~4,6 meses reales vs. "~3 meses" declarado) — DOC-10 es Tier T1, ya sellado y aprobado por el Director; se documenta como recomendación explícita en vez de autocorregir un documento aprobado. Verificado: `node --check` limpio sobre el bloque `<script>` completo; harness de M2 72/72 pass (antes 70/70); 895 ids en todo el Campus, 0 duplicados. Sigue: Informe Final de Nivel, Herencias Declaradas finales (Paso 9), auditoría adversarial, v1.0.0. | SYL-N3 §1, §3.8, §4, §5, §7.2; DOC-10 §6; EVT-065…073; `docs/informes/n1-auditoria-integral.md`, `n2-auditoria-integral.md` (formato precedente); `docs/informes/n3-auditoria-integral.md` |
| **EVT-073** | 2026-07-21 | Documento / investigación pedagógica | **Mayor** | **`docs/investigacion/n3-m1-algebra-lineal.md`, `n3-m2-calculo-optimizacion.md`, `n3-m3-probabilidad-estadistica.md`, `n3-m4-lectura-matematica.md` completos — investigación pedagógica formal de los 4 módulos de N3, mismo estándar de rigor que los documentos equivalentes de N2.** El Director pidió continuar con lo pendiente. Cada documento sigue el formato ya institucionalizado (cita textual verificada por WebFetch directo + fuente citada + párrafo de diseño pedagógico, cerrando con Clasificación y falsabilidad: evidencia sólida / ausencia declarada / falsabilidad). **Fuentes reales verificadas:** M1 — 7 capítulos individuales de 3Blue1Brown "Essence of Linear Algebra" (uno por tema) + Coursera Mathematics for ML (Imperial College) + documentación oficial de `numpy.linalg.inv`; M2 — 3 capítulos de "Essence of Calculus" + el mismo curso Coursera + la definición de Wikipedia sobre descenso de gradiente (citada explícitamente como fuente secundaria, no primaria); M3 — 4 páginas de Seeing Theory (Brown University) + documentación oficial de `numpy.cov`; M4 — documentación oficial de PyTorch (`torch.nn.Linear`) y scikit-learn (regresión logística). **Hallazgo genuino no anticipado, confirmado independientemente en dos frameworks reales de producción:** PyTorch define su capa lineal como `y=xAᵀ+b` (fila por matriz), mientras la ficha de M4.T2/T5 usa la convención `y=Wx+b`/`ŷ=σ(wᵀx+b)` (matriz por columna) — la MISMA divergencia de convención fila/columna que la propia ficha ya anticipaba como pregunta ingenieril, ahora confirmada como una confusión real que ocurre incluso entre bibliotecas oficiales distintas, no un riesgo hipotético inventado para el ejercicio. **Honestidad disciplinada en las ausencias:** Khan Academy confirmado como aplicación cliente sin contenido renderizable al fetch directo (3 intentos, todos vacíos) — no se fabricó cita; M4.T1/T3/T4 declaran honestamente no tener fuente externa verificable (consistente con el propio silencio de DOC-10 §6 sobre bibliografía de M4, verificado leyendo el documento, no asumido) en vez de forzar citas débiles. Ningún archivo modifica `index.html`, `syl-n3.md` ni el Blueprint — son documentos nuevos e independientes. | DOC-10 §6; SYL-N3 §5; `docs/investigacion/n2-m1-servicio.md` (formato precedente); `docs/investigacion/n3-m1-algebra-lineal.md`, `n3-m2-calculo-optimizacion.md`, `n3-m3-probabilidad-estadistica.md`, `n3-m4-lectura-matematica.md` |
| **EVT-072** | 2026-07-21 | Documento / paso institucional | **Mayor** | **SYL-N3 Paso 8 ejecutado — Revisión global del Capstone ET3 y las compuertas (§8, nueva sección).** El Director pidió continuar con lo pendiente. Siguiendo el mismo patrón institucional de SYL-N1/SYL-N2 (diseño de síntesis del capstone + tabla de instrumentos + cobertura de competencias), documentado en `docs/syllabus/syl-n3.md` §8: por qué el capstone exige integración real (hito 3 reutiliza las funciones del hito 2, no reimplementaciones sueltas); diferencia estructural declarada honestamente frente a N1/N2 (sin narrativa de ramas/PRs, ya que N3 es 100% Pyodide — SYL-N3 §3.1); las 4 competencias C-N3-01…04 verificadas con cobertura completa 1:1 contra los 4 módulos, sin hallazgos de omisión (a diferencia de C-N2-07 en SYL-N2, que quedó fuera de la compuerta de nivel por diseño). **Construido, además del formato narrativo ya usado en N1/N2, un banco de examen rotable concreto (NNR-02)** — 8 ítems (2 por competencia) × 3 variantes cada uno, con todos los valores numéricos verificados por ejecución real de Python antes de fijarse en el documento, ya que ningún nivel anterior había dejado un banco de ítems verbatim (solo la descripción estructural del instrumento) y la naturaleza de "derivar en vivo" de N3 lo hace más operativamente necesario aquí que en N1/N2. Pendiente de aprobación formal por el Director. Sigue: docs/investigacion/n3-*.md, Paso 9 (auditoría desde N4 + Herencias Declaradas finales), auditoría adversarial, v1.0.0. | SYL-N1; SYL-N2 §14; SYL-N3 §3.1, §8; EVT-071; `docs/syllabus/syl-n3.md` |
| **EVT-071** | 2026-07-21 | Contenido / capstone de nivel | **Mayor** | **Capstone ET3 "La matemática que puedes derivar en vivo" completo — mini-librería matemática propia + lectura comentada de un paper, integrando M1-M4.** El Director pidió continuar con lo pendiente. Construido bajo la modalidad `proyecto` ya institucionalizada en N1 (ET1, EVT-041) y N2 (ET2) — misma arquitectura técnica exacta (5 hitos autodeclarados vía checkbox + evidencia en bitácora libre, `S.ph[id]`, defensa oral como certificación real). **Adaptación deliberada respecto a ET1/ET2, no copia mecánica:** N3 es 100% Pyodide (SYL-N3 §3.1, sin ningún laboratorio de entorno real como N1/N2) — el capstone omite explícitamente el campo `flujoDeGit` y toda narrativa de ramas/Pull Requests que sí tienen ET1/ET2, porque el estudiante nunca sale del Campus en este nivel. Los 5 hitos integran los 4 módulos en un solo artefacto: h1 (propuesta de alcance de la librería + elección de un paper introductorio distinto al ya resuelto en M4.T5), h2 (núcleo de M1+M2 verificado contra numpy con tolerancia explícita — nunca comparación exacta), h3 (núcleo de M3 + una regresión completa de principio a fin usando la propia librería, exigiendo integración real, no funciones sueltas por hito), h4 (lectura comentada sistemática del paper elegido, aplicando M4.T1-T4), h5 (cierre + defensa oral con derivación en vivo de 3 funciones de módulos distintos). Verificado: `node --check` limpio sobre el bloque `<script>` completo; 893 ids en todo el Campus, 0 duplicados; **verificación adicional en navegador real** (Playwright/Chromium, mismo patrón de EVT-066) confirmando que `renderProyectoDay` renderiza el objeto nuevo sin excepciones, con sus 5 hitos y desbloqueo secuencial correcto. Sigue: compuertas (banco de examen + guión de defensa), docs/investigacion/n3-*.md, auditoría integral, Herencias Declaradas finales, auditoría adversarial, v1.0.0. | SYL-N3 §3.1, §6; EVT-041; EVT-066; EVT-070; `docs/syllabus/syl-n3.md` |
| **EVT-070** | 2026-07-21 | Contenido / cierre de módulo y de contenido regular de nivel | **Mayor** | **N3.M4 · Lectura matemática completo — 5 temas, 10 días, 55 ejercicios. Con este módulo, los 24 temas planificados de N3 quedan construidos por completo (M1:7 + M2:6 + M3:6 + M4:5) — todo el contenido regular del nivel existe.** El Director pidió continuar con lo pendiente. Construidos T1 (El alfabeto de la IA: griego, Σ y Π como bucles/acumuladores, con el desfase de índices 1..n matemático vs. 0..n-1 de Python como desafío final), T2 (Álgebra lineal en notación de papers: y=Wx+b, transposición, norma, con el bug real de olvidar Wᵀ), T3 (Cálculo en notación de papers: ∇, ∂ vs. d, argmin/argmax), T4 (Probabilidad en notación de papers: E[·], Var[·], P(·|·), X~N(μ,σ²), con la identidad Var(X)=E[X²]-(E[X])² verificada por ejecución real), y T5 (Lectura completa de un paper — cierra M4 y TODO N3 con una lectura comentada real de la fórmula de un clasificador binario simple ŷ=σ(wᵀx+b), la misma actividad que el proyecto de nivel de DOC-10 §6). Densidad de 2 días/tema (no 3, según SYL-N3 §3.8, por ser habilidad de lectura y no práctica procedimental repetida). **Hallazgo pedagógico real para el cierre del nivel:** el símbolo griego σ significa "desviación estándar" en M3/M4.T4 pero "función sigmoide" en T5 — la misma letra, dos conceptos distintos — usado deliberadamente como último desafío del nivel para enseñar que ni un símbolo ya familiar garantiza significado sin verificar el contexto, cerrando el arco pedagógico completo de N3 (de "verificar antes de confiar" en M1 a "verificar incluso la notación misma" en M4). Verificado: `node --check` limpio sobre el bloque `<script>` completo del Campus; harness final 55/55 pass; 892 ids en todo el Campus, 0 duplicados. **Pendiente para cerrar N3 por completo: capstone de nivel (mini-librería + lectura de paper, T5 ya es su núcleo), compuertas (examen + defensa con derivación en vivo), docs/investigacion/n3-*.md, auditoría integral + Informe Final de Nivel, Herencias Declaradas finales hacia SYL-N4, auditoría adversarial, v1.0.0.** | SYL-N3 §3.8, §6; EVT-067; EVT-068; EVT-069; `docs/syllabus/syl-n3.md` |
| **EVT-069** | 2026-07-21 | Contenido / cierre de módulo | **Mayor** | **N3.M3 · Probabilidad y estadística completo — 6 temas, 18 días, 72 ejercicios, tercer módulo íntegro de N3.** El Director pidió continuar con lo pendiente. Construidos T1 (Espacio muestral, eventos y probabilidad condicional — con la falacia del fiscal y el hallazgo de tasa base, verificados con Bayes y con un simulador de Monte Carlo), T2 (Variables aleatorias y distribuciones — Bernoulli, binomial y normal, con el Teorema del Límite Central demostrado empíricamente vía promedios de uniformes y sumas de dados), T3 (Esperanza, varianza y covarianza), T4 (Inferencia básica — muestreo, error estándar, intervalos de confianza, con verificación empírica de que la cobertura real del 95% se acerca a lo prometido), T5 (Introducción a pruebas de hipótesis mediante prueba de permutación, sin depender de fórmulas cerradas de distribuciones) y T6 (Estadística aplicada a un dataset real, cerrando M3 con un mini-proyecto EDA íntegro: inspeccionar → limpiar valores faltantes y atípicos → covarianza → regresión de M2.T6). **Hallazgo técnico real encontrado y verificado ANTES de escribir (mismo principio que el hallazgo de `numpy.linalg.inv()` de EVT-065/SYL-N3 §3.3, ahora en M3):** `numpy.var()` usa por defecto la convención poblacional (`ddof=0`), pero `numpy.cov()` usa por defecto la convención MUESTRAL (`ddof=1`) — dos funciones de la misma librería con defaults distintos entre sí; confirmado con ejecución real y convertido en lección explícita de T3, no en una fuente silenciosa de discrepancias. **Disciplina de verificación de reproducibilidad en Pyodide real extendida a cada primitivo nuevo del módulo `random`** usado por primera vez en el Campus (`random.gauss`, `random.sample`, `random.shuffle`, `random.randint`) — los 4 confirmados byte-idénticos entre Python nativo y Pyodide real antes de comitear cualquier valor a un `check()`, mismo estándar que ya regía `random.seed`/`random.uniform` desde M2. El harness comprehensivo de cierre (mismo patrón institucionalizado en EVT-067/EVT-068) encontró 1 error real: el desafío final de T6 usaba coeficientes de regresión YA REDONDEADOS de un ejercicio anterior para una predicción de extrapolación, produciendo una propagación de redondeo real (1421.77 vs. el 1421.78 de un script de verificación separado que recalculaba a precisión completa) — corregido ajustando el `check()` a la salida real del código exacto del ejercicio tal como está escrito, no a la de un cálculo distinto aunque relacionado. **Verificación de alcance ampliada respecto a M1/M2:** además de `node --check` sobre `LEVEL3` aislado, se verificó por primera vez la sintaxis del bloque `<script>` completo del Campus (1.48M caracteres) de una sola vez. Verificado: harness final 72/72 pass; 827 ids en todo el Campus, 0 duplicados. Sigue: M4 · Lectura matemática — el último módulo de N3. | SYL-N3 §3.3, §3.5, §3.8; EVT-067; EVT-068; `docs/syllabus/syl-n3.md` |
| **EVT-068** | 2026-07-21 | Contenido / cierre de módulo | **Mayor** | **N3.M2 · Cálculo y optimización completo — 6 temas, 18 días, 70 ejercicios, segundo módulo íntegro de N3.** El Director pidió continuar con lo pendiente. Construidos T1 (La derivada como límite/aproximación numérica), T2 (Reglas de derivación — cadena y producto), T3 (Derivadas parciales y gradiente), T4 (Descenso de gradiente 1D/2D — tasa de aprendizaje, divergencia, mínimos locales vs. globales), T5 (Series de Taylor — orden 0/1/2, radio de confianza) y T6 (Regresión lineal como descenso de gradiente sobre el MSE, cierra M2 con datos sintéticos reproducibles vía `random.seed`), todo derivado desde cero en Python puro (sin sympy), con numpy reservado solo para verificación puntual conforme a DOC-10. **Disciplina de verificación aplicada DURANTE la construcción, no solo al cierre** (recomendación directa de EVT-067): cada valor numérico se calculó primero con un script real antes de teclearlo en un `check()` — encontró y corrigió 5 errores reales antes de comitear, incluido un error real de sintaxis JavaScript en una pista (comillas sin escapar que habrían roto la carga de la página) y dos casos donde el valor intuido a mano difería sustancialmente del real (el más instructivo: la derivada numérica de `abs(x)` en un punto simétrico da `0.0`, no `-1.0` — el muestreo simétrico cancela exactamente, sugiriendo falsamente un punto crítico donde la función ni siquiera es diferenciable). **El harness comprehensivo de cierre (mismo patrón institucionalizado en EVT-067) encontró un sexto bug, más severo que cualquiera de M1**: el `check()` de T2.e4 usaba una expresión regular con `$` sin la bandera `m` (multilínea) — como la línea a verificar nunca es la última del código, la condición era matemáticamente imposible de cumplir para CUALQUIER envío, correcto o no; el ejercicio habría bloqueado a todo estudiante real. Corregido añadiendo la bandera `m`. El harness también señaló inicialmente un falso positivo (T1.e10, "ó" vs. "�") diagnosticado como artefacto propio del arnés (Python en Windows usa la página de códigos del sistema, no UTF-8, al escribir a través de un pipe) — corregido en el arnés (`PYTHONIOENCODING=utf-8`), no en `index.html`, ya que Pyodide en el navegador nunca pasa por esa ruta. Verificado: `node --check` limpio en los 4 niveles; harness final 70/70 pass; 737 ids en todo el Campus, 0 duplicados. Sigue: M3 · Probabilidad y estadística. | SYL-N3 §3.5, §3.8; EVT-067; `docs/syllabus/syl-n3.md` |
| **EVT-067** | 2026-07-21 | Contenido / cierre de módulo | **Mayor** | **N3.M1 · Álgebra lineal computacional completo — 7 temas, 21 días, 85 ejercicios, primer módulo íntegro de N3.** El Director pidió terminar N3 ("terminalo"). Construidos T2 (Combinaciones lineales/span/base), T3 (Matrices como transformaciones), T4 (Determinante 3D), T5 (Sistemas/inversa/espacio nulo — aplica en vivo el hallazgo empírico de `numpy.linalg.inv()` de EVT-065), T6 (Producto punto/proyecciones/similitud coseno) y T7 (Autovalores/autovectores/mini-PCA, cierra M1), todos bajo la densidad de 3 días/12-15 ejercicios fijada en SYL-N3 §3.8. **Hallazgo institucional del propio proceso, aplicado sobre sí mismo:** antes de comitear, se construyó un harness de Node que ejecuta la solución de referencia REAL de cada uno de los 85 ejercicios en Python, y compara la salida real contra el `check()` real extraído de `index.html` — no contra números tecleados a mano. Encontró **5 errores reales** que la verificación manual dispersa (Python suelto por ejercicio, sin este cruce sistemático) no había atrapado: (1) el laboratorio de T2 esperaba `(2, [1, 3])` cuando el resultado real de auditar 4 columnas con 2 pares redundantes es `(2, [0, 1, 2, 3])` — las 4 columnas son individualmente removibles porque ningún par completo desaparece al quitar una sola; (2) T3.e9 probaba con una matriz de 1 fila en vez de 2, dando un mensaje de error distinto al escrito en el `check()`; (3) **T4.e9 comparaba `mio == referencia` (flotante) exacto contra un determinante calculado por numpy — violando el propio principio de tolerancia que SYL-N3 §3.5 enseña**: numpy usa eliminación LU e introduce error real de redondeo incluso en casos "limpios" (5 vs 5.000000000000001), confirmado con ejecución real; corregido a `abs(mio-referencia) < 1e-9` y convertido en refuerzo explícito de la lección, no solo en un fix silencioso; (4) y (5) el laboratorio y ejercicio 10 de T7 (mini-PCA sobre datos reales) tenían autovalores/autovectores/proyecciones inventados a mano en vez de calculados con `numpy.cov`/`numpy.linalg.eig` reales — corregidos con los valores reales verificados. Los 3 ejercicios que tocan `numpy.linalg.inv()` sobre matriz singular (T5.e4, T5.e9, T5.x) se excluyeron deliberadamente de este harness (Python nativo SÍ lanza `LinAlgError`, a diferencia de Pyodide — habría sido una falsa alarma) y ya estaban verificados por separado contra Pyodide real. **Institucionalización:** este hallazgo confirma, con datos del propio proyecto, que la verificación ejercicio-por-ejercicio sin un cruce automatizado contra el `check()` real es insuficiente a esta escala — recomendado como práctica estándar para M2-M4 y para todo nivel futuro. Verificado: `node --check` limpio en los 4 niveles (`LEVEL0-LEVEL3`); harness final 85/85 pass (3 omitidos, verificados aparte); 649 ids en todo el Campus, 0 duplicados. Sigue: M2 · Cálculo y optimización. | SYL-N3 §3.5, §3.8; EVT-065; EVT-066; `docs/syllabus/syl-n3.md` |
| **EVT-066** | 2026-07-21 | Contenido / primera lección real de N3 | **Mayor** | **N3.M1.T1 "Vectores" completo — primer contenido real de N3, y primer caso del nuevo estándar de densidad ampliada.** El Director pidió completar los huecos de SYL-N3 y aumentar la densidad ("más información, más ejercicios, más problemas, recordando el nivel"). Se encontraron y corrigieron 5 huecos reales en el propio borrador antes de tocar `index.html` (los 5 estándares de N2 no estaban aplicados parejo en los 4 módulos: a M1 le faltaba "lo que deja de sorprender"; a M2, "la limitación humana que compensa"; a M3, "lo que deja de sorprender"; a M4 le faltaban "el quiebre de intuición" Y "el supuesto que destruye", pese a que la tabla resumen ya prometía uno) — inconsistencia hallada por revisión propia, no señalada por el Director. **Densidad ampliada codificada en SYL-N3 §3.8, con evidencia real, no por volumen:** investigación en práctica distribuida/intercalada en matemáticas (Rohrer & Taylor, 2007, *Instructional Science*; Rohrer, Dedrick & Stershic, 2015, *Journal of Educational Psychology*) — M1-M3 pasan de 2 a 3 días por tema (12-15 ejercicios, frente a ~9 del estándar N1/N2); M4 se mantiene en 2 días por ser habilidad de lectura, no práctica procedimental repetida. Esto sube la estimación total de N3 de ~3 a ~4,6 meses — declarado honestamente (mismo principio de transparencia de EVT-062), no ajustado a la cifra original. **`LEVEL3` creado en `index.html`** con el primer tema bajo el nuevo estándar: 3 días, 12 ejercicios + laboratorio integrador (centroide — puente directo a k-means/N4) + desafío final inédito (aliasing de listas de vectores, mismo mecanismo que N1 enseña, aplicado ahora a vectores). **Primer uso real de una librería binaria en todo el Campus:** se agregó carga *lazy* de `numpy` al runner de Pyodide (`runScriptedPy` en `index.html`) — solo se carga la primera vez que el código de un ejercicio contiene la palabra `numpy`, cacheada después; cero impacto en N0-N2, que nunca la importan. Verificado con ejecución real de Python antes de escribir cada ejercicio; `node --check` limpio; harness de Node con 20 aserciones (correcto + incorrecto), 0 fallos; 557 ids en todo el Campus, 0 duplicados; `LEVEL_META` ganó la entrada `n3`. **Verificación adicional real, no solo lógica (encontrada como hueco por revisión propia tras el cierre inicial):** se sirvió `index.html` en un servidor local y se ejecutó `runScriptedPy` del ejercicio 8 (el que carga numpy) dentro de un Chromium real vía Playwright — resultado `{ok:true, out:"True"}`, confirmando que la carga lazy de numpy funciona de punta a punta en el navegador real, no solo en el Node.js usado para investigar. Único error de consola capturado fue un 404 de `/favicon.ico`, sin relación. Pendiente: M1.T2-T7 y M2-M4 completos, luego el resto del flujo de 9 pasos. | DOC-11; SYL-N3 §3.8; EVT-065; `docs/syllabus/syl-n3.md` |
| **EVT-065** | 2026-07-21 | Documento / diseño de nivel | **Mayor** | **SYL-N3 v0.1.0-draft — inicio de la reconstrucción de N3, primer paso del flujo institucional de 9 pasos, exactamente como se declaró al cerrar N2 (EVT-061).** El Director pidió continuar la construcción de N3 a N12 "con el mismo régimen" de N0-N2. Verificado antes de planear: `docs/10-plan-maestro-curriculo.md` (DOC-10) ya tenía el desglose modular de N3 (4 módulos, competencias C-N3-01…04, proyecto, compuerta, bibliografía) con el mismo nivel de detalle que tuvo N2 antes de SYL-N2 — pero ningún `syl-n3.md` ni una sola línea de `LEVEL3` existían (`LEVELS` solo tenía `[LEVEL0,LEVEL1,LEVEL2]`, confirmado). Dada la escala real (10 niveles restantes, esfuerzo comparable a N1+N2 combinados varias veces), se decide reconstruir **un nivel a la vez, empezando por N3** — N4-N12 no se planifican en detalle todavía. **Investigación real verificada por WebFetch antes de diseñar** (no memoria): estructura real de 3Blue1Brown (Essence of Linear Algebra, 14 capítulos; Essence of Calculus, 12 capítulos), de la especialización Coursera "Mathematics for Machine Learning" (Imperial College/Deisenroth — 3 cursos, 15 semanas, ≈58h verificadas) y de Khan Academy. **Hallazgo real que motivó un PATCH a DOC-10** (v1.0.1→v1.0.2): ni 3Blue1Brown ni Deisenroth tienen un curso estructurado de probabilidad/estadística equivalente a su cobertura de álgebra/cálculo — se añadió **Seeing Theory** (Brown University, visualizaciones interactivas, 6 capítulos verificados por fetch directo) a la bibliografía oficial de N3.M3, en vez de aceptar a Khan Academy como único ancla real por defecto. **Verificación empírica real y crítica, ejecutada antes de comprometer cualquier ficha de M1** (Pyodide 0.26.4 corrido vía Node.js, la misma build exacta ya fijada en `index.html`): `numpy.loadPackage()` funciona sin fricción; pero **`numpy.linalg.inv()` sobre una matriz singular NO lanza `LinAlgError` en este sandbox WASM — devuelve silenciosamente una matriz de `nan`** (WASM no soporta excepciones de punto flotante como CPython nativo; confirmado también en pyodide/pyodide#4859). Este hallazgo se incorporó directamente al diseño: ninguna ficha de M1 puede enseñar `try/except LinAlgError` para detectar singularidad; la disciplina correcta (verificar `det()≈0` o `np.isnan()` antes) queda declarada explícitamente en M1.T5. **SYL-N3 v0.1.0-draft escrito completo**: 24 temas en 4 módulos (M1 Álgebra lineal computacional·7, M2 Cálculo y optimización·6, M3 Probabilidad y estadística·6, M4 Lectura matemática·5), con los 5 estándares específicos de N2 adaptados por decisión confirmada del Director — Momento Fundacional pasa a ser "el quiebre de intuición" (sin narrativa de responsabilidad-hacia-otros; N3 no tiene un "otro" que dependa del sistema del estudiante) y "la garantía que el sistema adquiere" se declara ausente honestamente, en vez de forzarla. Herencias Declaradas: resuelve H-N3-01…05 de SYL-N2 §15 y siembra un borrador H-N4-01…05 hacia Machine Learning. **Pendiente (no ejecutado en esta pasada):** revisión módulo por módulo con el Director, capstone, compuertas, auditoría desde N4, Herencias Declaradas finales, auditoría adversarial, v1.0.0 — y solo entonces, contenido real en `index.html` (`LEVEL3`). | DOC-10 v1.0.2; DOC-01; DOC-02; EVT-061; `docs/syllabus/syl-n3.md` |
| **EVT-064** | 2026-07-21 | Contenido / corrección de asimetría | Menor | **N1.M1.T6 (Laboratorio 3, "Módulos y paquetes propios") nivelado — hallazgo encontrado generando la referencia estructural completa de N0-N2 (88 temas/labs) a pedido del Director.** Con datos reales de los 38 laboratorios de entorno real en N0-N2, `n1m1t6a` tenía 3 pasos — el valor más bajo de todos, por debajo del rango normal (4-8). Peor: su paso 3 (mover un módulo a una subcarpeta) provocaba a propósito un `ModuleNotFoundError` y luego declaraba "el ajuste completo de paquetes con `__init__.py` queda fuera de alcance" — dejando sin resolver exactamente lo que el título del tema promete ("paquetes propios"). **Nuevo paso 4, verificado con ejecución real de Python 3.12 antes de escribirse:** confirmado que `from utils.saludo import saludar` ya funciona SIN `__init__.py` (namespace packages, PEP 420, Python 3.3+) — contradiciendo la premisa implícita del texto anterior; y que agregar `utils/__init__.py` con `from .saludo import saludar` permite `from utils import saludar` directo, curando la API pública del paquete. Corregida la `nota` del paso 3 (afirmación falsa de "fuera de alcance" reemplazada por el puente real al paso 4). +1 checkpoint, +1 pregunta de comprensión, objetivo y cierre de evaluación actualizados para reflejar que el tema ahora sí cubre paquetes, no solo módulos. Verificado: `node --check` limpio; secuencia de pasos 1-4 y checkpoints cp0-cp4 confirmados por script. | DOC-11; `docs/syllabus/syl-n1.md` §M1.T6 |
| **EVT-063** | 2026-07-21 | Campus / navegación | Menor | **Tarjetas de Ruta ahora navegan directo a Clases — feature real, no simulación.** El Director pidió poder hacer click en la tarjeta de un nivel en la vista "Ruta" para entrar directo a sus ejercicios en "Clases", tras varias rondas de scripts de consola para auto-completar progreso (explícitamente simulación, nunca guardados como cambio real). Esto es distinto: es una mejora de navegación real y permanente, no contenido pedagógico ni una forma de saltarse el progreso — respeta exactamente el mismo candado que ya gobierna las pestañas de Clases (`levelUnlocked()`, sin bypass). Nueva función `rutaAbrirNivel(n)` (junto a `switchLevel`, mismo patrón); `renderRuta()` añade `onclick`/`tabindex`/`onkeydown` solo a las tarjetas de N0-N2 genuinamente desbloqueadas (N3-N12 no tienen `LEVELS` real detrás, quedan sin click, sin excepción). Verificado: `node --check` limpio; patrón de escape de comillas idéntico al ya usado en `levelChips()` (mismo archivo, sin inventar uno nuevo). | DOC-07; `levelUnlocked`; `renderClases` |
| **EVT-062** | 2026-07-21 | Contenido / refuerzo por evidencia | **Mayor** | **Ronda de "temas débiles e importantes" — refuerzo dirigido por evidencia real, no por conteo de horas.** El Director pidió identificar temas débiles e importantes en N0-N2 y añadirles más teoría/ejercicios. Verificación con datos reales (barrido de theory/ex/errores en los ~65 temas de los 3 niveles) mostró que la inmensa mayoría ya está construida a la misma densidad uniforme (3-6 teoría, 9 ejercicios) — no hay un grupo grande de temas objetivamente débiles por conteo. Se evaluaron 4 candidatos con contenido ya construido (Composición vs herencia, los 4 laboratorios de Git, primer servicio FastAPI de N2, concurrencia de N2.M3) y los 3 restantes con evidencia CS-Ed real verificada por WebSearch: **Recursión** — evidencia académica fuerte y replicada (Lister et al., 2004, *SIGCSE Bulletin* 36[4]:119-150, multi-institucional); **Generadores/`yield`** — un paper directamente on-point (Johnson, McQuistin & O'Donnell, 2020, CEP — lazy evaluation como fuente de conceptos erróneos ligados al "notional machine" de du Boulay); **Decoradores/closures** — evidencia real pero indirecta (Fisler et al. 2017 SIGCSE; Krishnamurthi & Fisler 2021 ICER, sobre scope/HOF en general, no decoradores específicamente) y contenido ya sólido (`n2m1t1` ya tenía predicción de orden de ejecución) — se decide NO tocarlo. **Recálculo del gap de horas post-expansión de esta sesión:** N0 (~28-32h de ~100-200h declaradas), N1 (~173-184h de 500h), N2 (~83h de ~400h) — el gap apenas se movió (N1: 69%→65%) pese a duplicar temas en 4 módulos; perseguir la cifra literal exigiría cientos de horas más de contenido por nivel, inviable sin caer en relleno. Única asimetría real y ya documentada que el propio presupuesto señaló: N2.M4 con menos pasos que sus hermanos (hallazgo 🟡 de `n2-auditoria-integral.md`). **Alcance final acordado con el Director (combinando evidencia + presupuesto, evidencia como prioridad):** (1) **Recursión** (`n1m3t5`/`n1m3t5b`) gana 2 teorías (traza completa de `factorial(3)` con sangría por profundidad; explosión combinatoria real de Fibonacci ingenuo — 15→177→21,891 llamadas para n=5,10,20, verificado con ejecución real), 1 MCQ, 2 ejercicios (traza de entrada/salida; recursión múltiple real — caminos en cuadrícula, verificado 6/10/70) y 1 error habitual nuevo (hipótesis recursiva de una rama vs. múltiple); (2) **Generadores** (`n1d7`) gana un refuerzo puntual — 1 teoría (traza intercalada generador↔llamador, verificada con ejecución real), 1 MCQ y 1 ejercicio, cerrando exactamente el hueco que señala el paper de 2020; (3) **N2.M4** (Laboratorios 29-32) nivelado — cada uno gana 1 paso real y su checkpoint (AUDITORIA.md versionado en T1; TDD sobre caso de error en T2; `--cov-fail-under` en T3; confirmación de la prueba original post-refactor en T4), quedando en 5 pasos/5 checkpoints a la par de sus hermanos (T5, Momento Fundacional con 8 pasos, sin tocar). Todo verificado con ejecución real de Python antes de escribir cada ejemplo, `node --check` limpio, harness de Node con 8 aserciones nuevas (0 fallos) y comprobación de unicidad de ids/checkpoints. `n2-auditoria-integral.md` y `n2-informe-final-de-nivel.md` actualizados (hallazgo M4 marcado 🟢 corregido). | DOC-11; DOC-12; EVT-061; `docs/informes/n2-auditoria-integral.md`; SYL-N1; SYL-N2 |
| **EVT-061** | 2026-07-20 | Contenido / cierre de nivel | **Mayor** | **N2 · Software Engineering congelado como versión de desarrollo v1.0 — segundo nivel de la Academia auditado por un comité adversarial de 4 revisores independientes antes de su cierre.** A diferencia de N1 (construido rápido, corregido en una segunda pasada tras 8 hallazgos críticos), N2 se construyó desde el origen bajo el estándar acordado tras la propia auditoría de N1 (EVT-044) — la auditoría de 10 dimensiones encontró **6 defectos reales, todos corregidos dentro de la misma pasada, ninguno crítico sin resolver:** (1) M5 (Laboratorios 35-36) con diagnóstico muy delgado (1.40 vs. 2.6-2.83 del resto), llevado a 3 entradas c/u, ancladas en contenido ya presente (`errorVivo`, `desafio`); (2) **promesa de persistencia SQLite en M1 nunca construida, afirmada falsamente en `n2m3t2`** ("SQLite usado desde... M1 de este nivel") — corregida alineando el texto con la realidad (diccionarios en memoria, decisión deliberada de M1), sin reconstruir código ni retrofittear una capa de persistencia innecesaria, dado que el propio Capstone no depende técnicamente de esto (PostgreSQL llega de verdad en M3); (3) C-N2-06 (inglés técnico) declarada "distribuida" en SYL-N2 §14 cuando se practica en las 27 de 27 fichas; (4) **arqueología del Capstone apuntaba a M1.T1** (decorators, Pyodide, sin estado ni commits) **en vez de M1.T2/Laboratorio 13** (primer repositorio real) — corregido en 3 ubicaciones (hito h4, checklist, SYL-N2 §14); (5) C-N2-05 subdescrita en la tabla de §14 (omitía M3); (6) mención de Docker sin calificar antes de su tema formal (M5). **8 riesgos menores registrados como pendientes, ninguno bloqueante:** M4 con menos pasos que el promedio, hints de `n2m1t1` que regalan soluciones, ausencia de comparación institucional en la investigación, autonomía de Bitácora sobrevendida narrativamente, cierre sin gesto hacia N3, puente narrativo N1→N2 incumplido, numeración Día/Laboratorio confusa en la transición, monotonía de modalidad (92.8% real). **Hallazgo positivo confirmado, no asumido:** a diferencia de N1, la integración M1-M5 es real (mismo `main.py`, misma `productos_db` reutilizados de tema en tema, verificado línea por línea) y ninguna disciplina de depuración quedó ausente fuera del sandbox — ambos problemas que N1 sí tuvo. `LEVEL_META.n2.approved` actualizado de `()=>false` a lógica real (`LEVEL2.every(dayDone)`), mismo patrón que N1 tras su propio cierre. Verificado: `node --check` limpio; 724 ids sin duplicados reales. Informes completos en `docs/informes/n2-auditoria-integral.md` y `docs/informes/n2-informe-final-de-nivel.md`. **Comienza la reconstrucción de N3.** | DOC-11; DOC-12; EVT-044; EVT-045; `docs/informes/n2-auditoria-integral.md`; `docs/informes/n2-informe-final-de-nivel.md`; SYL-N2 |
| **EVT-060** | 2026-07-20 | Contenido / profundización estructural | **Mayor** | **N0.M1 gana T9 (Funciones básicas) y T10 (Lectura de código ajeno) — dos temas nuevos, bajo la excepción de reapertura de EVT-059.** N0 pasa de 8 a 10 temas. **T9** cierra un salto de dificultad real, verificado leyendo el propio contenido de N1.M1.T1 (su primer ejemplo ya exige entender `return` vs. `print` sin que el estudiante haya escrito una función antes) — investigado con CS50P (introducción con refactorización real, `cat.py`) y **UC Berkeley/CS61A, verificado por fetch directo con cita textual exacta**: *"it implicitly returns None when no other value is returned"* — el mecanismo preciso detrás del bug de "olvidar el return" que el desafío final del tema hace practicar. CMU no tiene, en el material encontrado, un tratamiento equivalente para principiantes — ausencia declarada honestamente. **T10 se ancla en evidencia real de Learning Sciences/CS-Ed, leída directamente de la fuente primaria (PDF), no de memoria ni de resumen de segunda mano:** Lister et al. (2004, ACM SIGCSE Bulletin) — estudio multi-nacional que encontró que estudiantes con menos de 50% de precisión de trazado tampoco podían explicar el código efectivamente; Hertz y Jump (2013) — el modelo "trace-based-teaching" aumentó el rendimiento y redujo el abandono al dedicar 20-30 min de trazado al inicio de cada clase; el enfoque PRIMM (Predict-Run-Investigate-Modify-Make) y el concepto de "notional machine" (du Boulay, 1986). Todos los ejercicios de T10 usan código con nombres y estilo deliberadamente "de otro autor" (variables cortas, convenciones distintas), replicando la condición exacta que la literatura mide. **Decisión de diseño explícita: NO se densificaron T1-T8 ya construidos** (evitaría agravar la Hipótesis #6 de sobrecarga, del Informe Final de N0 v2, todavía sin validar) — solo se añadió anchura donde un gap estructural real fue verificado. Renumeración mecánica de ids internos (`d9`→`d9proyecto`, `d10`→`d10examen`) para liberar la secuencia natural `d9`/`d9b`/`d10`/`d10b` para los temas nuevos — solo 3 referencias de id en todo `index.html`, verificadas una por una antes y después del cambio; los números "Día N" mostrados al estudiante permanecen limpios y secuenciales (1-24), sin sufijos tipo "bis" (precedente rechazado, EVT-036). SYL-N0 actualizado a v1.1.0 (tabla resumen, temario, grafo local, mapeo de competencias, historial con la excepción documentada). Verificado: `node --check` limpio; estructura de las 23 entradas de `LEVEL0` confirmada campo por campo; harness de Node con 26 aserciones (correcto + incorrecto) sobre los 14 `check()` nuevos, 0 fallos; 724 ids totales en el Campus, 0 duplicados reales. Investigación completa en `docs/investigacion/n0-t9-funciones-basicas.md` y `docs/investigacion/n0-t10-lectura-codigo-ajeno.md`. **Con esto se completa toda la ronda de profundización solicitada por el Director (N1 completo + N0) — sigue N2, tras completar su auditoría integral.** | DOC-11; EVT-059; `docs/investigacion/n0-t9-funciones-basicas.md`; `docs/investigacion/n0-t10-lectura-codigo-ajeno.md`; SYL-N0 v1.1.0 |
| **EVT-059** | 2026-07-20 | Decisión / excepción de reapertura | **Mayor** | **N0 reabierto para profundización estructural — segunda excepción explícita de esta ronda (tras EVT-053 para N1), con una condición propia que N1 no tenía.** A diferencia de N1 (congelado por EVT-043 sin ninguna cláusula de no-reapertura más allá del principio general "evidencia real, no ideas nuevas"), N0 v2 tiene una política MÁS estricta, declarada explícitamente en su propio Informe Final de Nivel: *"Toda modificación futura de N0 dependerá exclusivamente de evidencia obtenida durante la validación real..., nunca de una idea nueva por sí sola"* — mecanismo operativo en DOC-11 §6bis (los tres estados independientes de una lección: Desarrollo/Validación/Mejora continua), reforzado además por una Hipótesis #6 ya registrada y sin validar (riesgo de sobrecarga: "N0 v2 es sustancialmente más denso que v1... riesgo real... mayor de lo sostenible para 25h/semana"). **El Director, informado de ambas restricciones, otorgó la excepción explícitamente** tras revisar el mismo desglose de horas que motivó EVT-053, extendido a N0. **Condición aceptada por el propio diseño de la excepción: no agravar la Hipótesis #6.** En vez de densificar T1-T8 (ya reconstruidos bajo el Estándar de Excelencia Mundial, EVT-029, y ya en el límite superior de su propia hipótesis de sobrecarga), se añaden T9 y T10 como temas nuevos que cierran un gap estructural real y verificado (N0 nunca introduce funciones antes de que N1 las presuponga) — anchura, no densidad, precisamente para no empeorar el riesgo ya declarado. Esta excepción NO valida ni resuelve la Hipótesis #6 — queda registrada como pendiente, exactamente como antes. | DOC-11 §6bis; `docs/informes/n0-informe-final-de-nivel.md`; EVT-029; EVT-053; SYL-N0 v1.1.0 |
| **EVT-058** | 2026-07-20 | Contenido / cierre de ronda de profundización | **Mayor** | **N1.M7 · SQL pasa de 4 a 6 temas — quinto y último módulo de la ronda de profundización de N1 (EVT-053).** Dos temas nuevos: **T5 · Índices y planes de consulta** (índice como el mismo BST de M3.T7 aplicado dentro del motor SQL, verificado con cita textual real de sqlite.org sobre la ganancia O(n)→O(log n); `EXPLAIN QUERY PLAN` con los tres formatos reales de salida —`SCAN`, `SEARCH USING INDEX`, `SEARCH USING COVERING INDEX`— confirmados con ejecución real de `sqlite3`, no solo documentación) y **T6 · Normalización y claves foráneas avanzada** (`ON DELETE CASCADE`/`SET NULL`, detección de violación de 1NF, cierre de M7 y de todo N1). **Hallazgo real, verificado con ejecución de Python, convertido directamente en el primer ejercicio del tema:** SQLite tiene las claves foráneas desactivadas por defecto — el mismo esquema con `ON DELETE CASCADE` deja un huérfano intacto sin `PRAGMA foreign_keys = ON`, y sí propaga el borrado con el PRAGMA activo, confirmado comparando ambas ejecuciones reales, no asumido. CS50 Week 7 (SQL), ya identificado durante la investigación de EVT-053 mediante WebFetch, incorporado explícitamente a la bibliografía de M7 — cerraba un hallazgo pendiente de la auditoría integral (EVT-042). T5 cierra además un hilo que M7.T2 ya había abierto sin resolver ("alguien calcula el Big-O de M3 por ti"), y T6 detecta un tipo de violación de normalización distinto al ya cubierto por T4 (evitando duplicar el concepto). M7 ahora cierra con T6 (se corrigió el título de `n1m7t4b` que aún decía "cierre de M7"). Verificado: `node --check` limpio; harness de Node con 24 aserciones (correcto + incorrecto) sobre los 14 `check()` nuevos, 0 fallos; 702 ids totales, 0 duplicados reales. Investigación completa en `docs/investigacion/n1-m7-t5-t6-indices-normalizacion.md`. **Con esto se completa la ronda de profundización de los 5 módulos señalados (M2/M3/M4/M6/M7, EVT-054 a 058) — N1 pasa de 65 a 78 temas Pyodide/real + Git profundizado sin cambio de conteo. Sigue: la misma profundización aplicada a N0 (con su propia excepción de reapertura), y luego a N2 (tras completar su auditoría integral).** | DOC-11; EVT-042; EVT-053 a EVT-057; `docs/investigacion/n1-m7-t5-t6-indices-normalizacion.md`; SYL-N1 §M7 |
| **EVT-057** | 2026-07-20 | Contenido / profundización estructural | **Mayor** | **N1.M6 · Redes y APIs pasa de 4 a 6 temas — cuarto módulo de la ronda de profundización (EVT-053), cierra un hallazgo de la auditoría integral de N1 que había quedado parcialmente resuelto.** Dos temas nuevos: **T5 · Autenticación básica** (401 vs. 403, ambos verificados por fetch directo de MDN, con cita textual exacta de la distinción entre ambos; credencial vía `os.environ`, integrando M6.T2) y **T6 · Límites y buenas prácticas** (429/`Retry-After` verificado por fetch directo de MDN; paginación; idempotencia con idempotency key real — cierra el hilo abierto por `n1m6t4x`, que ya usaba `es_idempotente` en abstracto sin mecanismo concreto). **Cierre explícito de un hallazgo de EVT-042:** la auditoría integral de N1 había encontrado que el marco de H-06 ("¿quién eres? ¿cómo lo sé? ¿qué puedes?") tenía mecánica práctica en M6.T2 pero nunca aparecía nombrado verbatim — T5 lo nombra directamente y lo ancla a 401 (falla la segunda pregunta) y 403 (falla la tercera); H-06 actualizada en SYL-N1 citando este cierre. **Decisión de diseño declarada:** T5/T6 permanecen autocontenidos (clases/diccionarios locales por ejercicio, mismo patrón de T1) en vez de extender el `API_PREAMBLE` compartido de M6 (solo 3 fixtures fijas) — evita acoplar temas nuevos a un simulador ya usado por T2-T4, cero riesgo de regresión. CS50/Missing Semester: ausencia declarada (ninguno cubre auth de API, rate limiting, paginación o idempotencia). M6 ahora cierra con T6 (se corrigió el título de `n1m6t4b` que aún decía "cierra M6"). Verificado: `node --check` limpio; harness de Node con 26 aserciones (correcto + incorrecto) sobre los 14 `check()` nuevos de T5/T6, 0 fallos; 680 ids totales, 0 duplicados reales. Investigación completa en `docs/investigacion/n1-m6-t5-t6-auth-limites.md`. **Sigue: M7 (SQL) — último módulo de esta ronda.** | DOC-11; EVT-042; EVT-053; `docs/investigacion/n1-m6-t5-t6-auth-limites.md`; SYL-N1 §M6 |
| **EVT-056** | 2026-07-20 | Contenido / profundización estructural | **Mayor** | **N1.M4 · Git profundizado dentro de sus 4 laboratorios existentes — tercer módulo de la ronda de profundización (EVT-053), y único caso donde el Director decidió NO crear temas nuevos** (evita tocar el contador "Laboratorio N" compartido con N2). Laboratorio 6 (Ramas y merge, `n1m4t2`) gana rebase interactivo (squash de commits) y `git stash`/`stash pop`. Laboratorio 8 (README/historia, `n1m4t4`) gana `git blame` y `git bisect` — instanciando con herramientas reales el apartado de "arqueología del software" que el propio SYL-N1 ya describía en prosa ("cuándo apareció un bug, leer la historia hacia atrás") sin nombrar la herramienta concreta; corregido para citar `git bisect` explícitamente. **Los 4 comandos verificados con ejecución REAL de Git antes de escribir la lección, no solo con documentación:** rebase interactivo confirmado combinando 2 commits en 1 (`GIT_SEQUENCE_EDITOR` automatizado); stash/pop confirmado dejando el árbol de trabajo limpio y restaurando el cambio exacto; blame confirmado con su formato real de salida; **bisect confirmado con un caso construido a propósito** — historial de 8 commits con un bug insertado deliberadamente en un commit intermedio, `git bisect run` con script de detección automática encontró el commit exacto sin intervención manual. **Missing Semester (MIT), Version Control, verificado por WebFetch:** confirma que la MISMA clase enseña Git básico y avanzado juntos, no en labs separados — la justificación pedagógica directa de profundizar en vez de crear un laboratorio nuevo. Regla de seguridad de rebase (nunca sobre historia ya compartida) declarada explícitamente como error habitual y como entrada de diagnóstico propia, no como nota al margen. Verificado: `node --check` limpio; 658 ids totales, 0 duplicados reales. Investigación completa en `docs/investigacion/n1-m4-git-avanzado.md`. **Sigue: M6 (Redes), M7 (SQL) — únicos dos módulos restantes de esta ronda.** | DOC-12; EVT-053; `docs/investigacion/n1-m4-git-avanzado.md`; SYL-N1 §M4 |
| **EVT-055** | 2026-07-20 | Contenido / profundización estructural | **Mayor** | **N1.M3 · Algoritmos y ED I pasa de 6 a 8 temas — segundo módulo de la ronda de profundización (EVT-053).** Dos temas nuevos: **T7 · Árboles y recorridos** (Nodo con izq/der, in/pre/post-order recursivos, inserción en BST manteniendo la propiedad de orden, búsqueda O(altura) explotando ese orden) y **T8 · Tablas hash y coste amortizado** (función hash propia, encadenamiento para colisiones, medición REAL de comparaciones — no tiempo de ejecución, frágil en un sandbox de navegador — comparando búsqueda lineal vs. hash, y tabla demasiado pequeña vs. adecuada). **CS50 Week 5 (Data Structures) verificado por fetch directo antes de diseñar** (cs50.harvard.edu/x/weeks/5/): confirma explícitamente árboles/BST y tablas hash como contenido de esa semana — cita ya identificada durante la investigación de EVT-053, ahora instanciada por tema. **Hallazgo real verificado con ejecución de Python, no fabricado a mano:** "ab", "ba" y "cc" colisionan las tres en una tabla de tamaño 3 (suma de códigos Unicode: 195, 195, 198 — las tres módulo 3 = 0), usado como ejemplo real de colisión triple en T8. T7 reutiliza T4 (pilas/colas, contraste) y T5 (recursión, mecanismo) — su ejercicio 5 conecta explícitamente con T3 (Ordenación), construyendo un algoritmo de ordenación completo sobre un BST. T8 reutiliza T1 (Big-O) y T2 (Búsqueda) para MEDIR la ganancia real de una tabla hash, no solo prometerla. M3 ahora cierra con T8 (antes cerraba con T6; se corrigió el título de `n1m3t6b` que aún decía "cierra M3"). Verificado: `node --check` limpio; harness de Node con 24 aserciones (correcto + incorrecto) sobre los 14 `check()` nuevos de T7/T8, 0 fallos; 654 ids totales en el Campus, 0 duplicados reales. Investigación completa en `docs/investigacion/n1-m3-t7-t8-arboles-hash.md`. **Sigue: M4 (Git), M6 (Redes), M7 (SQL).** | DOC-11; EVT-053; EVT-054; `docs/investigacion/n1-m3-t7-t8-arboles-hash.md`; SYL-N1 §M3 |
| **EVT-054** | 2026-07-20 | Contenido / profundización estructural | **Mayor** | **N1.M2 · POO pasa de 5 a 7 temas — primer módulo profundizado bajo la excepción de reapertura de EVT-053, y primer caso real del estándar "profundizar sin relleno" que el Director exigió.** Dos temas nuevos: **T6 · Clases abstractas y protocolos** (`abc.ABC`/`@abstractmethod`, `typing.Protocol`/`@runtime_checkable`, ambos verificados por fetch directo a docs.python.org) y **T7 · Testing de clases con pytest** (patrón Arrange-Act-Assert, invariantes, simulado con `assert` nativo por límite real de plataforma — Pyodide no tiene mecanismo de instalación de paquetes, mismo tipo de límite ya declarado en N1.M6 y N2/EVT-045). **Hallazgo real encontrado durante la construcción (no asumido), y convertido directamente en el desafío final de T6:** `isinstance()` contra un `Protocol` con `@runtime_checkable` solo verifica que un atributo con el nombre correcto EXISTA — no que sea invocable ni tenga la firma correcta; un objeto con `self.area = "texto"` (string, no método) pasa la verificación igual que uno con un método real, confirmado con ejecución real de Python antes de escribir el ejercicio. T6/T7 reutilizan deliberadamente las clases de T5 (`ValidadorLogin`, `MonitorSensor`) como material propio, y T7 siembra explícitamente hacia H-04 (testing/TDD) y el concepto de cobertura que N2.M4 formalizará. **CS50/Missing Semester: ausencia declarada honestamente** (verificado por WebFetch directo de ambos syllabi — ninguno cubre POO ni testing de clases como contenido propio); la bibliografía de M2 permanece anclada en fuentes específicas de Python, sin forzar una conexión institucional inexistente. SYL-N1 actualizado (tabla resumen, fichas de T6/T7, corrección de un desliz preexistente en H-04 que citaba "N2.M3" para TDD en vez de "N2.M4"). Verificado: `node --check` limpio; harness de Node con 26 aserciones (correcto + incorrecto) sobre los 14 `check()` nuevos de T6/T7, 0 fallos. Investigación completa en `docs/investigacion/n1-m2-t6-t7-contratos-y-testing.md`. **Sigue: M3 (Algoritmos), M4 (Git), M6 (Redes), M7 (SQL) — mismo estándar, uno por uno.** | DOC-11; EVT-053; `docs/investigacion/n1-m2-t6-t7-contratos-y-testing.md`; SYL-N1 §M2 |
| **EVT-053** | 2026-07-20 | Decisión / excepción de reapertura | **Mayor** | **N1 reabierto para profundización estructural — excepción explícita, mismo patrón institucional que exigió EVT-043 al congelar el nivel.** El Director, tras revisar el desglose real de días/laboratorios de N1 en la Ruta (5 meses declarados ≈500h a 25h/semana, contra ~150-160h de contenido realmente construido), consideró el nivel corto para un estudiante que empieza de cero — hallazgo confirmado con números, no solo percepción. Investigación externa verificada por WebFetch (no memoria): **CS50 (Harvard)** Week 3 = Algoritmos/Big-O, Week 5 = Estructuras de datos (árboles, hash tables, pilas/colas), Week 7 = SQL — **no cubre POO ni HTTP/APIs como tema propio**; **Missing Semester (MIT)** enseña Git básico y avanzado (rebase, stash, bisect, blame) en una sola clase, no en varias. **Decisión del Director tras plan presentado y aprobado (EnterPlanMode):** profundizar M2 (POO), M3 (Algoritmos), M6 (Redes/APIs) y M7 (SQL) con 2 temas nuevos cada uno; profundizar Git (M4) DENTRO de sus 4 laboratorios existentes (rebase/stash/bisect/blame), sin crear un 5º laboratorio dedicado — decisión explícita del Director para evitar renumerar el contador compartido "Laboratorio N" con N2 (que empieza en "Laboratorio 13" precisamente porque N1 termina en 12). **Corrección de enfoque exigida explícitamente por el Director a mitad de la planificación:** "mantén la calidad... no quiero relleno... nivel top mundial, dificultad" — cada tema nuevo debe ganarse su lugar con investigación real y dificultad genuina, nunca ser volumen añadido; mismo estándar ya exigido en EVT-051 para N0/N1/N2. Mismo tratamiento se extenderá después a N0 (con su propia excepción de reapertura, dado el §6bis de DOC-11) y a N2 (tras completar su auditoría integral, hoy a medias). Plan completo conservado en el historial de la sesión; ejecución módulo por módulo, verificada y subida antes de continuar con el siguiente. | DOC-11; EVT-043; EVT-051; SYL-N1 |
| **EVT-052** | 2026-07-20 | Contenido / cierre de todo el contenido regular | **Mayor** | **Capstone ET2 · "El backend que puede vivir sin ti" construido — cierre de todo el contenido regular de N2, fiel al diseño ya aprobado en SYL-N2 §14 (paso 8).** Modalidad `proyecto` reutilizada sin cambios de arquitectura (mismo contrato de tres funciones, mismo almacén `S.ph[id]`, mismo renderizador `renderProyectoDay` que ya sirvió al Capstone ET1 de N1) — coherente con el principio de EVT-041 de no reabrir una pieza congelada de DOC-07 sin necesidad real. **Hallazgo real encontrado y corregido antes de escribir el capstone:** `renderProyectoDay` tenía tres cadenas de texto codificadas de forma fija ("Síntesis de todo N1", "síntesis de los 7 módulos", "los 5 hitos... certificación real de N1") que habrían etiquetado incorrectamente el capstone de N2 con datos de N1 — corregido parametrizando por `d.nivelLabel`/`d.modCount` (con fallback a N1/7 para no romper `n1et1`, al que además se le agregaron esos dos campos explícitamente) y por `hitos.length` real en vez de un número fijo. **Diseño de los 5 hitos, fiel al episodio integrador ya aprobado en el syllabus (no una interpretación libre):** auditoría honesta de las cinco garantías → diseño del cambio de requisito real → el episodio integrador (las cinco garantías —contrato M1, permisos M2, concurrencia M3, pipeline M4, despliegue sin pausa M5— demostradas en una sola operación, no en cinco entregas separadas) → arqueología completa de commits + post-mortem → cierre con defensa TD-02 y la pregunta de validación final ("¿confiaría el examinador en ti para mantener un sistema real que utilizan otras personas?", estándar permanente de todo capstone desde SYL-N2 §14). Checklist de evaluación (7 ítems) mapea explícitamente cada garantía a su evidencia verificable, no a una autodeclaración genérica. Verificado: `node --check` limpio; 29 entradas en `LEVEL2` (28 regulares + capstone); cadena de 5 hitos con bloqueo secuencial confirmada en simulación de Node (`dayDoneProyecto` false con 0/5 y 4/5 hitos marcados, true con 5/5); ids `h1`…`h5` confirmados como locales por tema (mismo patrón ya establecido de `cp0`…`cp4`), 0 colisiones reales en 610 ids totales del Campus. **Con esto, N2 tiene todo su contenido regular (M1-M5) y su capstone construidos; queda pendiente la auditoría integral de N2 y su Informe Final de Nivel antes de congelarlo, exactamente como ocurrió con N1 (EVT-042/043).** | DOC-07; EVT-041; EVT-045; EVT-050; SYL-N2 §14; `index.html` |
| **EVT-051** | 2026-07-20 | Contenido / corrección retroactiva de densidad | **Mayor** | **Estándar de densidad "4-5 unidades (ejercicio o práctica equivalente) + teoría por entrada, adaptado por modalidad" aplicado retroactivamente a N0, N1 y N2 completos — mandato directo del Director, corregido a mitad de camino por una segunda instrucción de calidad.** El Director ordenó primero elevar cada entrada de tema a un promedio de 4-5 ejercicios más teoría añadida ("por cada entrada individual... todos los temas, adaptando el concepto" según aclaración vía pregunta directa); al revisar el primer lote de ejercicios añadidos, corrigió con **"que no sea solo relleno, que sean problemas o ejercicios reales de alto nivel"** — el Director seleccionó explícitamente "reemplazar por problemas integradores" como resolución. Desde ese punto, todo ejercicio nuevo combina 2-3 conceptos de temas relacionados en un solo problema realista (nunca una demostración aislada de una sola característica de sintaxis), verificado con ejecución real de Python antes de insertarse. **N0:** 8 entradas Parte-2 (`d1b`…`d8b`) llevadas de 2 a 4-5 unidades. **N1:** 30 entradas Parte-2 estándar across M1-M7 (incluida la reapertura excepcional del nivel congelado en EVT-043, autorizada explícitamente por el Director para esta corrección puntual) más el caso especial `n1m4t4` (modalidad `real`, sub-par frente a sus pares: 3 checkpoints/4 pasos → 4/5, cerrando el ciclo error-vivo/prevención ya declarado en su propio diagnóstico en un paso verificable real). **N2:** `n2m1t1b` (2 ejercicios integradores de decoradores: validación con `functools.wraps`, decorador parametrizado con estado) y `n2m4t1`/`t2`/`t3` (cada uno con solo 3 checkpoints/1 diagnóstico frente al 4-5/2-3 de sus pares en el resto de N2 — corregido añadiendo 1 checkpoint + 2 diagnósticos por tema, cada uno atado a contenido pedagógico ya presente en el propio tema —errorVivo, miniLab, comprensión— nunca inventado de la nada). Ejemplos representativos de la disciplina "integrador": composición de dos llamadas API con caché (evitar peticiones redundantes); `JOIN`+`GROUP BY`+`HAVING` combinados sobre datos reales; inserción por lotes todo-o-nada con `rollback`; auditoría de esquema que detecta dos tipos de problema en la misma pasada. **Verificación:** `node --check` limpio en todo el script; 604 ids totales en el Campus, 0 duplicados reales (excluidos los `cp0…cp4` de `checkpoints[]`, locales por diseño a cada tema); arneses de Node con más de 30 aserciones nuevas (código correcto + incorrecto) sobre los `check()` añadidos o modificados, 0 fallos. **Pendiente:** aplicar el mismo estándar, desde el origen, al Capstone ET2 y a la reconstrucción de N3-N12; auditoría integral de N2 e Informe Final de Nivel siguen pendientes por separado. | DOC-11; DOC-12; EVT-042; EVT-043; EVT-050; `index.html` |
| **EVT-050** | 2026-07-20 | Contenido / cierre de módulo | **Mayor** | **M5 · Entregar sin Miedo (5 temas, Laboratorios 34-38) construido y verificado — quinto y último módulo regular de N2, cierre del arco completo del nivel.** Chequeo DP-17 aplicado: densidad consistente con M1-M4 (T4, el Momento Fundacional, es la síntesis de todo el nivel: tráfico continuo de Bitácora sostenido durante todo el tema, predicción escrita de la migración "big bang", aplicación completa del patrón expandir-contraer con verificación medida de cero interrupciones) — **DP-17 NO se dispara**. Investigación verificada con WebFetch real: definición oficial de contenedor de Docker (cita textual: "simply an isolated process with all of the files it needs to run", coincidente sin adaptación con el modelo mental ya diseñado en SYL-N2); patrón **Parallel Change** de Martin Fowler (fuente autoritativa de la industria, no convención inventada) para expandir-contraer; Python Logging HOWTO oficial para observabilidad básica. **Decisión de diseño declarada honestamente:** T3 (despliegue gradual) usa dos contenedores locales en vez de un proveedor de nube real, por consistencia con AC-15 (autonomía del funcionamiento esencial) — declarado como límite deliberado, no como omisión. **Con M5 completo, los cinco módulos regulares de N2 (M1-M5) quedan construidos: 28 entradas de tema en `LEVEL2`, 35 ids únicos, 0 duplicados, `node --check` limpio.** Queda pendiente: Capstone ET2, auditoría integral de N2 e Informe Final de Nivel. | DOC-11; DOC-12; DP-17; EVT-049; `docs/investigacion/n2-m5-entregar.md` |
| **EVT-049** | 2026-07-20 | Contenido / cierre de módulo | **Mayor** | **M4 · La Red de Seguridad (5 temas, Laboratorios 29-33) construido y verificado — cuarto módulo de N2, formalización del hilo transversal sembrado desde M1.T2.** Chequeo DP-17 aplicado: densidad comparable a M1-M3 (T5, el Momento Fundacional, incluye pipeline real de GitHub Actions + un cambio deliberadamente elegido por el propio estudiante que debe romper una prueba real, no un ejemplo scripted) — **DP-17 NO se dispara**. Investigación verificada con WebFetch real: pytest (`getting-started.html`, descubrimiento `test_*.py`, sintaxis assert), coverage.py (cita textual: "monitors your program... identify code that could have been executed but was not"), GitHub Actions (`.github/workflows/`, disparador `on: [push]`). **Ausencia declarada honestamente:** coverage.py no incluyó en el fetch una advertencia textual explícita sobre "alta cobertura ≠ buenas pruebas" — esa idea se presenta como criterio pedagógico propio (ya diseñado en SYL-N2 T3), no como cita de la fuente. El cierre de B-M4 (Laboratorio 33) conecta explícitamente con el Momento Fundacional de M1 (Bitácora) sin repetir la escena, tal como exige SYL-N2. Verificado: `node --check` limpio; 23 entradas de tema acumuladas en `LEVEL2` (M1-M4), 30 ids únicos, 0 duplicados. | DOC-11; DOC-12; DP-17; EVT-048; `docs/investigacion/n2-m4-calidad.md` |
| **EVT-048** | 2026-07-20 | Contenido / cierre de módulo | **Mayor** | **M3 · Muchos a la Vez (5 temas, Laboratorios 24-28) construido y verificado — tercer módulo de N2, el más exigente del nivel según el propio Director.** Chequeo DP-17 aplicado: aunque M3 tiene 5 entradas de tema frente a las 7 y 6 de M1/M2, la densidad por tema es comparable o mayor (el Momento Fundacional, T3, incluye un experimento de concurrencia diseñado para ser reproducible de forma determinista, con predicción escrita, diagnóstico de secuencia entrelazada y una prueba que documenta el fallo antes de resolverlo en T4) — **DP-17 NO se dispara**. Investigación verificada con WebFetch real: la analogía oficial de las hamburguesas de FastAPI (`fastapi.tiangolo.com/async/`) para concurrencia vs. paralelismo, coincidente de fuente primaria con el modelo mental ya diseñado en SYL-N2 ("un cocinero que atiende varias mesas"); arquitectura cliente/servidor de PostgreSQL con fork por conexión (`tutorial-arch.html`); semántica exacta de Redis EXPIRE (`redis.io/docs/latest/commands/expire/`). **El experimento de condición de carrera (T3) se diseñó con un `await asyncio.sleep()` deliberado para forzar el entrelazado de forma reproducible** — declarado explícitamente como decisión de diseño pedagógico, no como artificio oculto, con su propia falsabilidad registrada en la investigación (`docs/investigacion/n2-m3-concurrencia.md`) por si el timing no se reproduce consistentemente en hardware distinto. T4 verifica la corrección repitiendo EXACTAMENTE el mismo experimento de T3 (antes/después medido, no narrado) — mismo principio de verificación ya exigido en toda la Academia. Verificado: `node --check` limpio; 18 entradas de tema acumuladas en `LEVEL2` (M1+M2+M3), 25 ids únicos, 0 duplicados. | DOC-11; DOC-12; DP-17; EVT-047; `docs/investigacion/n2-m3-concurrencia.md` |
| **EVT-047** | 2026-07-20 | Contenido / cierre de módulo | **Mayor** | **M2 · La Confianza (6 temas, Laboratorios 18-23) construido y verificado — segundo módulo completo de N2. Primera aplicación real de DP-17 (§8.4): comparación explícita de ritmo de construcción contra M1, la línea base del nivel.** Densidad comparable a M1 (13 secciones DOC-12 por laboratorio, investigación verificada en cada tema, sin atajos): **DP-17 NO se dispara** — no hay aceleración sospechosa que amerite una auditoría dedicada anticipada; el chequeo se deja registrado explícitamente, no omitido, tal como exige el principio. Investigación verificada con WebFetch real: documentación oficial de FastAPI (`oauth2-jwt`) confirmando **pwdlib+Argon2** como recomendación vigente (reemplazando la guía más antigua de solo passlib+bcrypt) y **PyJWT** como librería actual (reemplazando `python-jose`); ranking oficial de OWASP Top 10:2021 confirmando que Broken Access Control ocupa el primer lugar (con ausencia declarada honestamente: la página profunda específica de A01 devolvió 404/redirección repetida, se cita solo lo verificado con certeza — el ranking). **El Momento Fundacional de M2 (T4) se implementó como ataque ejecutable, no narrado:** el tutor, en un rol nuevo (Atacante, propuesto por SYL-N2 §10 para el catálogo vivo de DOC-03 §19.5.3 — incorporación formal registrada como pendiente administrativa, no bloqueante), cambia ids en URLs reales del servicio del estudiante y expone un patrón de autorización rota, exigiendo diagnóstico del patrón completo (no solo el caso) antes de reparar — mismo principio de causa-raíz ya exigido en las correcciones de N1. El hilo de Bitácora se extiende sin discontinuidad desde M1 (llama libremente → debe identificarse → es rechazada sin credencial → se reintegra con mínimo privilegio). Verificado: `node --check` limpio; 13 entradas de tema acumuladas en `LEVEL2` (M1+M2), 20 ids únicos, 0 duplicados. | DOC-11; DOC-12; DP-17; EVT-046; `docs/investigacion/n2-m2-confianza.md` |
| **EVT-046** | 2026-07-20 | Contenido / cierre de módulo | **Mayor** | **M1 · El Servicio (6 temas, Laboratorios 13-17 + N2.M1.T1 en Pyodide) construido y verificado — primer módulo completo de N2, nacido directamente con el estándar final de calidad acordado tras el cierre de N1 (EVT-043/044), no con el ciclo "construir rápido, corregir después".** T1 (decoradores/closures) vive en Pyodide, drill aislado sin estado (EVT-045); T2-T6 en modalidad `real` (DOC-12), sobre un único servicio FastAPI continuo en la terminal del estudiante. Investigación verificada con WebFetch real en cada tema: Python Glossary y PEP 318 (con cita textual de Guido van Rossum sobre la elección arbitraria de `@`) para T1; documentación oficial de FastAPI (`first-steps`, `testing`) para T2, confirmando que el propio ejemplo canónico ya usa `async def`; Pydantic v2 (`concepts/models`) y `response_model` de FastAPI para T3; la tesis doctoral de Roy Fielding (2000, UC Irvine) para el diseño REST de T4; `handling-errors` de FastAPI para T5; `metadata` de FastAPI para T6. **El Momento Fundacional de todo N2 (T4) se implementó como experiencia ejecutable, no narrada:** el estudiante corre un script real (`bitacora_cliente.py`) contra su propio servicio antes y después de un cambio de contrato sin versionar, y ve el `KeyError` real en su propia terminal — mismo principio de error inducido en vivo ya validado en N1 (Laboratorio 12). El hilo de Bitácora atraviesa T2→T6 sin discontinuidad (nace, guarda datos reales, se rompe, negocia, se reintegra), y `functools.wraps` reaparece deliberadamente en el desafío final de T1 combinado con el apilamiento de decoradores — aplicando la lección de N1 de que las competencias deben reaparecer, no visitarse una sola vez. Verificado: `node --check` limpio; 7 entradas de tema en `LEVEL2`, 14 ids únicos, 0 duplicados; harness de Node con 14 aserciones (correcto + incorrecto) sobre los 8 `check()` de T1, 0 fallos. Sin línea base de N2 previa contra la cual aplicar DP-17 todavía — M1 la establece para M2 en adelante. | DOC-11; DOC-12; EVT-044; EVT-045; `docs/investigacion/n2-m1-servicio.md` |
| **EVT-045** | 2026-07-20 | Decisión / arquitectura de plataforma | **Mayor** | **Arquitectura de contenido de N2 resuelta antes de construir el primer tema — mismo reflejo institucional que EVT-034/EVT-030: detenerse ante una pregunta arquitectónica real en vez de construir sobre ella sin resolverla.** Prueba técnica directa (Pyodide real ejecutado en Node, no lectura de documentación) confirmó que FastAPI + Pydantic v2 corren genuinamente dentro de Pyodide (`fastapi`/`starlette` instalables por micropip desde oct. 2025) — pero solo con `async def` en cada endpoint; tanto los manejadores síncronos (`def`) como el propio `TestClient` que SYL-N2 M1.T2 nombra explícitamente **fallan** con `RuntimeError: can't start new thread` (Pyodide/WASM no tiene hilos de sistema operativo reales, y ambos dependen de uno). Más de fondo: la propia ficha de M1.T2 exige un servicio que **"sigue vivo… entre sesiones reales"**, con Bitácora llamando mientras el estudiante no está — algo que un sandbox de navegador no puede sostener bajo ningún diseño, por ser frontera de plataforma (el proceso muere al cerrar la pestaña), no limitación de contenido — exactamente el mismo tipo de límite que ya obligó a diseñar la modalidad `real` en EVT-034. **Decisión del Director:** M1–M5 de N2 (todo el bloque que extiende el servicio persistente + el hilo narrativo de Bitácora) se construyen en modalidad `real` (DOC-12), en la terminal propia del estudiante — coherente con la identidad del nivel ("código que sigue siendo tuyo cuando cierras la terminal") y con el precedente ya validado de N1 (M4, M5, Laboratorio 12). Pyodide queda reservado para ejercicios aislados sin estado que no dependan de un proceso vivo (p. ej. un decorador suelto en M1.T1, codificar/decodificar un JWT en M2.T2). Verificación conservada en `docs/investigacion/n2-arquitectura-servicio-real.md`. | DOC-07; DOC-12; EVT-034; SYL-N2 M1.T2; `docs/investigacion/n2-arquitectura-servicio-real.md` |
| **EVT-044** | 2026-07-20 | Norma / Design Principle | **Mayor** | **DP-17 · Velocidad como señal de riesgo, incorporado a §8.4 — Blueprint 2.0.0.** El Director ordenó formalizar como principio institucional permanente, no dependiente de la intuición, el hallazgo más importante de la Auditoría Integral de N1 (EVT-042/EVT-043): los 8 hallazgos críticos convergieron casi en su totalidad en el tramo del nivel construido más rápido (M6, M7, vínculo Git↔Capstone). DP-17 establece que toda unidad de N2–N12 construida significativamente más rápido que sus comparables activa **automáticamente** una auditoría más profunda antes de congelarse — sin esperar a que la intuición del Comité o del Tutor la señale. Procedimiento de 8.7 aplicado: añadir un principio es MAJOR por definición; re-auditoría de documentos citantes con **alcance vacío** (DP-17 es de creación nueva, nada lo citaba todavía); no contradice DP-01…DP-16. Blueprint asciende de 1.1.0 a **2.0.0**. **Con N1 formalmente cerrado (EVT-043) y esta lección institucionalizada como regla ejecutable, comienza la construcción de N2 con el objetivo explícito de nacer directamente en el estándar final de calidad, sin repetir el ciclo "construir rápido, corregir después".** | §8.4 (DP-17); §8.7; 0.4 (2.0.0); EVT-042; EVT-043 |
| **EVT-042** | 2026-07-20 | Corrección / cierre de auditoría | **Mayor** | **Las 8 correcciones críticas de la auditoría integral de N1 (`docs/informes/n1-auditoria-integral.md`) aplicadas y re-verificadas — corrección de causa, no parche.** (1) Git como hábito: los 5 hitos del Capstone ahora exigen entrega por rama+PR desde el hito 2, el checklist restituye "ramas, PRs propios" (antes solo "historia que narra"), y se creó el **Laboratorio 12 · Tu primera llamada real** (nuevo, DOC-12) que ensaya M4+M5+M6+M7 juntos en la terminal real del estudiante antes del Capstone — resuelve a la vez el hallazgo de integración (#6). (2) M6 elevado a 5 ejercicios por tema (antes 3) y M7 a 4/5/3/3 (antes 3/3/3/1), cada ejercicio nuevo con función pedagógica declarada (analogía postal de Berkeley CS168, contraste GET/POST de CS50, relación N-M, LEFT JOIN sobre el misconception real de NULL=NULL documentado en Miedema et al. ICER 2021), no relleno. (3) Los 4 "laboratorios" con solución pre-resuelta (`n1m6t1r`, `n1m6t4r`, `n1m7t1r`, `n1m7t3r`) ahora exigen construcción real desde cero. (4) Investigación pedagógica de M6/M7 ampliada con comparación institucional real (CS50 Harvard, Berkeley CS168/CS186) y dos papers reales de CS-Ed (Poulsen et al. SIGCSE 2020, Miedema et al. ICER 2021), honrando el mismo estándar de M1.T1. (5) M1 y M3 ahora gateados explícitamente en los hitos 2 y 5 del Capstone, no solo en el checklist final. (7) C-N1-07 declarada en M6.T2. (8) Type hints incorporados como extensión opcional de M1.T1 + nueva fila H-10 en SYL-N1. Incidentalmente corregidos: la referencia adelantada a Git en Laboratorio 4 (hallazgo #9) y la desincronización de SYL-N1 §4 con la linealización real de M4/M5 (hallazgo #10), y el desafío final trivial de `n1m7t3x` (ahora exige detectar dependencia real entre pasos, no solo contar la lista). **Re-verificación (no auditoría completa, solo áreas afectadas):** `node --check` limpio; harness de Node con 44 aserciones nuevas (correcto+incorrecto) sobre los `check()` modificados/nuevos, 0 fallos; 65 temas en `LEVEL1`, 326 ids únicos, 0 duplicados; render en vivo de las 7 áreas modificadas sin fugas de datos; cadena de hitos del Capstone re-verificada con el nuevo diseño de ramas/PR, `dayDone`/"Capstone completo" funcionando igual que antes. | DOC-11; DOC-12; `docs/informes/n1-auditoria-integral.md`; `docs/lecciones/n1/puente-t1-tu-primera-llamada-real.md`; `docs/investigacion/n1-m6-redes-apis.md`; `docs/investigacion/n1-m7-sql.md` |
| **EVT-040** | 2026-07-20 | Contenido / cierre de módulo | **Mayor** | **M7 (SQL, 4 temas, Días 45-52) construido bajo DOC-11 — último módulo regular de N1, cierra la construcción de contenido de lecciones del nivel.** Investigación verificada con WebFetch (documentación oficial Python sqlite3 sobre inyección SQL, OWASP, historia de Codd 1970/IBM con ausencia honesta declarada de cita textual, ACID en sqlite.org/transactional.html, problema N+1 en SQLAlchemy). T3 enseña la inyección SQL de forma experimental (el estudiante ejecuta el ataque contra código inseguro y confirma que falla contra código parametrizado), tal como pide explícitamente SYL-N1. **Hallazgo de calidad real durante la construcción, corregido antes de dar el módulo por bueno:** un error sistemático de conteo de llaves de cierre (`}` faltantes o sobrantes según si `check()` usaba una expresión ternaria o un cuerpo de bloque) causado por copiar el patrón equivocado entre ejercicios — detectado por `node --check`, corregido iterativamente hasta sintaxis limpia, y solo entonces validado funcionalmente. Un segundo error de escape de comillas (`\\'` vs `\'` en Python embebido dentro de strings JS) también encontrado y corregido de la misma forma. Verificado: `node --check` limpio; 63 temas en `LEVEL1`, 305 ids únicos, 0 duplicados; harness de Node con 23 aserciones (correcto + incorrecto, incluidas guardas estructurales contra inyección SQL sin parametrizar) sobre los 10 `check()` de M7, 0 fallos. **N1 tiene ahora los 7 módulos regulares completos (M1-M7); pendiente solo el capstone ET1, la auditoría integral y el Informe Final de Nivel.** | DOC-11; `docs/investigacion/n1-m7-sql.md` |
| **EVT-039** | 2026-07-20 | Contenido / cierre de módulo | **Mayor** | **M6 (Redes y APIs, 4 temas, Días 37-44) construido bajo DOC-11 — primer módulo desde M3 en volver a la modalidad Pyodide, tras M1.T6/M4/M5 en modalidad real.** Investigación verificada con WebFetch (MDN HTTP/status codes, requests Quickstart, Google SRE sobre backoff exponencial, GitHub Secret Scanning, tenacity). **Hallazgo técnico real declarado con honestidad, no fabricado:** el motor `getPyodide()` no tiene configurado ningún mecanismo de red (sin `pyfetch` ni el shim `pyodide-http` que `requests` necesitaría) — confirmado por ausencia en el código. Decisión de diseño: los ejercicios usan un cliente HTTP simulado (`api_get`/`FakeResponse`, constante `API_PREAMBLE`) con fixtures fieles a la estructura REAL verificada de `jsonplaceholder.typicode.com/users/1`, declarado explícitamente al estudiante como continuación del principio ya sembrado en M5.T1 ("esto es el simulador, la máquina real es distinta"). Un bug real de mayúsculas/minúsculas en el email fixture fue encontrado y corregido por el harness de verificación antes de dar el tema por bueno (mismo patrón de esta Academia: nunca confiar en un check sin probarlo contra código correcto e incorrecto). Verificado: `node --check` limpio, harness de Node con 32 aserciones (correcto + incorrecto) sobre los 8 `check()`, 0 fallos; 55 temas en `LEVEL1`, 280 ids únicos totales, 0 duplicados. | DOC-11; `docs/investigacion/n1-m6-redes-apis.md` |
| **EVT-038** | 2026-07-20 | Contenido / cierre de módulos | **Mayor** | **M4 (Git/GitHub, Laboratorios 5-8) y el resto de M5 (Procesos, Memoria/permisos, Automatización — Laboratorios 9-11) construidos y verificados, en modo de flujo continuo tras la estabilización de DOC-07/DOC-12.** Investigación real verificada con WebFetch en ambos módulos (Pro Git, GitHub Docs, Conventional Commits, reglas de Beams, Art of README, Google eng-practices para M4; Missing Semester, man7.org signal/chmod/ps, ShellCheck para M5), con ausencias declaradas honestamente donde corresponde (GitHub no documenta buenas prácticas de redacción de PR; `set -euo pipefail` es convención comunitaria, no característica oficial de Bash; la filosofía Unix de McIlroy solo verificada por WebSearch, no fetch directo). Los 7 laboratorios nuevos aplican, desde el origen, el estándar DOC-12 ya corregido (voz de instructor, tarjetas agrupadas, `.warnbox`/`.notebox`, numeración "Laboratorio N"). Verificado con el mismo arnés de Node de EVT-036/037: 47 temas en `LEVEL1`, cero duplicados, orden correcto, 14-15 tarjetas por laboratorio, cero fugas de datos, cadena de checkpoints funcional en los 7. **N1 queda con M1, M4 y M5 100% completos; pendiente M6, M7, capstone y auditoría integral.** | DOC-12; EVT-036; EVT-037; SYL-N1 M4/M5; `docs/lecciones/n1/m4-*.md`; `docs/lecciones/n1/m5-t3/t4/t5-*.md` |
| **EVT-037** | 2026-07-20 | Contenido / cierre de laguna curricular | **Mayor** | **N1.M1.T6 construido — se cierra la última laguna de M1, diferida desde EVT-031.** Con DOC-07 y DOC-12 estabilizados, el Director instruyó retomar el currículo en modo de flujo continuo (parar solo por contradicción arquitectónica, evidencia pedagógica fuerte, hallazgo institucional, o bloqueo técnico — nunca por perfeccionismo). Aplicando el principio ya aprobado de "una competencia por laboratorio" (usado en M5), T6 se dividió en dos laboratorios DOC-12 en vez de uno: **Laboratorio 3 · Módulos y paquetes propios** (organización multi-archivo, `__main__`, imports circulares) y **Laboratorio 4 · Entornos virtuales y pip** (aislamiento de dependencias, el error de "instalar sin activar" documentado con evidencia real de `pypa/pip` issue #11154, `requirements.txt`). Investigación real verificada (packaging.python.org como única fuente que ancla el "por qué" en un conflicto concreto antes de comandos; PEP 405 e Ian Bicking 2007 para la historia real de `virtualenv`→`venv`; Missing Semester "Packaging and Shipping Code" 2026, confirmado su contenido antes de asumirlo). Construidos ya con las correcciones UX de EVT-036 incorporadas desde el origen, no como parche posterior: tarjetas agrupadas (13 y 15 respectivamente, en el mismo rango que M5.T1/T2 tras su corrección), `nota` separada de `resultado`, `.warnbox` para advertencias, numeración "Laboratorio N" continuando la secuencia. Verificado con el mismo arnés Node de EVT-036: 40 temas en `LEVEL1`, cero duplicados, orden de inserción correcto, cero fugas de datos, cadena de checkpoints funcional. | DOC-12; EVT-031; EVT-033; EVT-036; SYL-N1 M1.T6; `docs/lecciones/n1/m1-t6-laboratorio3-modulos-propios.md`; `docs/lecciones/n1/m1-t6-laboratorio4-venvs-pip.md` |
| **EVT-036** | 2026-07-20 | Auditoría / cierre de pieza | **Mayor** | **Auditoría UX de la arquitectura de modalidades — 5 hallazgos bloqueantes corregidos, pieza de DOC-07 congelada.** Tras EVT-035, el Director exigió una última validación de experiencia de aprendizaje antes de congelar — no solo que el código funcionara. Auditoría ejecutada recorriendo el Campus con un arnés Node que carga el script real en un contexto `vm` y ejecuta las funciones reales (no lectura estática): encontró F1 (crítico — instrucciones del autor mostradas dentro de la caja de "salida de terminal", rompiendo la honestidad visual que DOC-12 exige) y F2-F5 (importantes — 19-21 tarjetas por laboratorio real frente a 4-5 en Pyodide; reuso de `.kobox` de "error" para advertencias neutras; numeración "Día 10bis/10ter" rompiendo la secuencia; badge de modalidad repetido sin necesidad en cada tarjeta Pyodide). El Director aprobó corregir las cinco y, además, aplicar F6/F7 (nudge no bloqueante de reflexiones pendientes; conteo en el título de diagnóstico) por pasar el criterio "¿mejora la experiencia del estudiante?", difiriendo F8 (rail de posición por sección) por no pasarlo todavía. Correcciones aplicadas y re-verificadas con el mismo método: reducción de tarjetas de ~25-30% agrupando secciones pasivas (objetivo+contexto+requisitos+explicación; mini-lab+desafío; buenas prácticas+recursos) sin quitar contenido; nuevas clases `.warnbox`/`.notebox` distintas de `.kobox`/`.termout`; "Laboratorio 1/2" reemplaza la numeración rota; badge de modalidad solo en no-default. Cero regresiones. **Principio institucionalizado por el Director para todo componente visual futuro del Campus: debe responder afirmativamente a propósito pedagógico, reducción de carga cognitiva, claridad de navegación, información útil, e integración natural — si alguna respuesta es negativa, se rediseña o se elimina.** | DOC-07; EVT-035; `docs/informes/ux-auditoria-modalidades-campus.md`; `index.html` |
| **EVT-035** | 2026-07-20 | Implementación / plataforma | **Mayor** | **Registro de modalidades implementado en el Campus (`index.html`) — primera vez que el motor renderiza contenido no-Pyodide, y N1.M5.T1/T2 quedan jugables en producción.** Implementación fiel a EVT-034: `MODALIDADES={pyodide,real}` con contrato describe/evaluar por modalidad; `dayDone` delega en `evaluar()` sin lógica propia (`dayDoneEx` extraída sin cambios de comportamiento, `dayDoneReal` nueva); `dayUnlocked` extendido con una condición de una línea para reconocer temas `real` como puerta de gating; `renderRealDay` como renderizador autocontenido (ficha con duración desglegable, pasos en formato consola reutilizando `.codebox`/`.term`, tabla de diagnóstico plegable con `<details>`, checkpoints con `label.task` — CSS ya existente, sin componentes nuevos salvo dos reglas para `details/summary`). Checkpoints y evidencia de texto persisten en `S.ph[id]` (mismo almacén que ya usaban `intuit`/`mcq`, sin segundo sistema de progreso). Decisión de recorrido lineal (EVT-034) aplicada: M5.T1/T2 insertados como entradas normales del array `LEVEL1`, en la posición exacta donde M1.T6/T9 (entornos virtuales) ya los declaraba como prerrequisito — sin campo de "pista" ni bifurcación. Verificación realizada: sintaxis validada con `node --check` sobre el script extraído; unicidad de ids y orden de inserción verificados aislando `LEVEL1` en Node; correspondencia exacta entre los campos que `renderRealDay` espera y los campos presentes en los dos temas nuevos, verificada campo por campo. **Verificación NO realizada:** prueba visual en navegador real (sin herramienta de navegador disponible en el entorno de esta sesión) — recomendada antes de dar por cerrada la implementación. | EVT-034; DOC-07; DOC-12; `index.html`; `docs/lecciones/n1/m5-t1-entorno-real.md`; `docs/lecciones/n1/m5-t2-terminal.md` |
| **EVT-034** | 2026-07-20 | Documento / arquitectura de plataforma | **Mayor** | **Primera arquitectura de producto del Campus aprobada — registro de modalidades de contenido, primera pieza real de DOC-07.** Al descubrir que los laboratorios DOC-12 (M5.T1/T2) no tenían dónde renderizarse en el Campus —construido asumiendo un único tipo de contenido, ejercicios Pyodide con corrección automática—, se detuvo la construcción de más laboratorios de entorno real hasta diseñar la arquitectura de convivencia (mismo reflejo institucional que EVT-030/EVT-033: no seguir construyendo sobre una base sin resolver). Diseño aprobado: campo `modalidad` explícito por tema + registro `MODALIDADES` con contrato de tres funciones (renderizar/evaluar/describir); Pyodide se re-trata como la primera modalidad registrada, no como caso base especial; `dayDone` delega siempre en la función `evaluar()` de la modalidad — un único punto de indirección mantiene unificado el sistema de progreso existente sin duplicarlo. Checkpoints de laboratorios reales resueltos en tres categorías honestas y nunca mezcladas: autodeclaración (avance, no certificación), evidencia de texto (para defensa del Tutor IA), verificación funcional real (pospuesta explícitamente). Hallazgo de escalabilidad: la mayoría del contenido futuro (Docker/Cloud/SQL/Linux/GUI) cabe en la modalidad `real` ya generalizada por la propia auditoría de DOC-12 — solo se anticipan `entrevista` y `proyecto` como modalidades genuinamente nuevas, sin diseñarlas todavía. **Decisión adicional del Director, elevada a principio de diseño permanente:** el Campus presenta un recorrido lineal único (sin pistas paralelas) pese a que SYL-N1 describe M5 como paralelo a M1 — justificado porque la Academia sirve a un solo estudiante, no a cohortes; "la complejidad arquitectónica solo se acepta cuando aporta una mejora clara a la experiencia de aprendizaje". La arquitectura permanece capaz de soportar recorridos paralelos en el futuro sin rediseño, aunque la primera implementación no los construya. | DOC-07; 15.3; DOC-12; EVT-032; EVT-033 |
| **EVT-033** | 2026-07-20 | Corrección / redundancia curricular + Contenido | **Mayor** | **N1.M5.T1 y N1.M5.T2 construidos como primeros laboratorios reales bajo DOC-12 — con una condición de parada aplicada primero.** Al implementar la directiva del Director de crear un nuevo tema de "orientación a la terminal" en M1 (M1.T6), la revisión de dependencias cruzadas de SYL-N1 encontró que **M5.T1 "El entorno real" y M5.T2 "La terminal"** —ya aprobados, ya declarados "en paralelo desde semana 1" con M1, y ya citados como prerrequisito del propio M1.T6 original— cubrían casi punto por punto el contenido que se estaba a punto de duplicar. La inserción se revirtió íntegra antes de tocar ningún otro documento (mismo reflejo institucional de EVT-030: detenerse ante una contradicción real en vez de construir sobre ella). Presentada la disyuntiva, **el Director confirmó: el syllabus aprobado es la fuente de verdad — no se crean temas nuevos, se enriquece la profundidad de los existentes.** M5.T1 y M5.T2 se construyeron completos bajo DOC-12 v1.0.0 (investigación pedagógica propia cada uno, 13 secciones, voz de instructor, duración desglosada, error inducido en vivo, debugging con comprobación de hipótesis) sin alterar su posición ni numeración en SYL-N1: M5.T1 construye el cambio de modelo mental Campus/Pyodide → entorno real (qué garantizaba el sandbox, qué nunca pudo hacer, qué no cambia); M5.T2 construye la fluencia de navegación de terminal (prompt, directorio actual, crear/listar/eliminar, ejecutar Python, diagnosticar errores de ruta) como el único prerrequisito de terminal que la Academia exige — ningún laboratorio futuro (Git, venvs, Docker, SSH) volverá a explicar estos fundamentos. Ambos, deliberadamente, excluyen Git, venv y pip. | SYL-N1 M5.T1/T2; DOC-12; `docs/lecciones/n1/m5-t1-entorno-real.md`; `docs/lecciones/n1/m5-t2-terminal.md`; `docs/investigacion/n1-m5-t1-entorno-real.md`; `docs/investigacion/n1-m5-t2-terminal.md` |
| **EVT-032** | 2026-07-20 | Documento / cierre de fase | **Mayor** | **DOC-12 v1.0.0 aprobado — Estándar de Laboratorios de Entorno Real, documento hermano de DOC-11.** Redactado a instrucción directa del Director tras EVT-031 (13 secciones obligatorias — Objetivo, Contexto, Requisitos, Explicación conceptual, Ejecución paso a paso, Comprensión, Puntos de verificación, Diagnóstico de errores, Mini laboratorio, Desafío, Buenas prácticas profesionales, Recursos recomendados, Evaluación), fundamentado en investigación real verificada (MIT Missing Semester, The Carpentries, Pro Git, Stanford CS107, Berkeley CS61B/CS61C). **Sometido a auditoría crítica adversarial explícita sobre 9 criterios del Director** (`docs/informes/doc12-auditoria-critica-v0.1.0-draft.md`) antes de su aprobación — no bastaba con revisión pasiva. La auditoría encontró y corrigió 13 debilidades reales, 8 de ellas bloqueantes: ausencia de exigencia de voz narrativa de instructor (causa raíz de que el borrador leyera como documentación); duración anunciada sin desglose ni justificación real (el propio ejemplo de validación prometía 45-60 min con contenido de 15-20); debugging sin paso de comprobación de hipótesis ni checklist de categorías de error; ningún error inducido en vivo, solo documentado como referencia pasiva; y tres sesgos tácitos hacia Git/terminal que rompían la reutilización universal del formato para GUI (VS Code), entornos remotos/administrados (CI/CD, Kubernetes) y acciones irreversibles o con costo económico real (cloud). Las 13 correcciones se aplicaron íntegras antes de esta aprobación; el laboratorio de ejemplo (`git init`) se reescribió por completo para demostrarlas, corrigiendo además un bug real de verificación de directorio (`cd` sin argumentos se comporta distinto en bash que en Windows) encontrado al auditar el ejemplo como si fuera un estudiante nuevo. Registrado también como hallazgo abierto, no resuelto aquí: la Academia nunca enseñó orientación básica a terminal antes de M4 — decisión de currículo pendiente para cuando se construya M4.T1 real. Rige, sin excepción, T6, M4 y M5 en adelante. | DOC-12; 15.3; auditoría crítica; EVT-031 |
| **EVT-031** | 2026-07-20 | Decisión / secuencia de construcción | Menor | **N1.M1.T6 (Módulos, paquetes y entornos virtuales) diferido — no es una laguna, es una decisión explícita del Director.** Al preparar T6 se detectó que su propia ficha en SYL-N1 exige "verificación en máquina real" y declara M5.T1 ("entorno real instalado") como prerrequisito — algo que Pyodide (el motor de ejecución de N1, un sandbox de navegador) no puede satisfacer bajo ningún diseño de ejercicio, por ser una frontera de plataforma (sin sistema de archivos ni proceso real), no una limitación de contenido. El mismo límite ya estaba señalado internamente para M4 y M5 completos (el "Principio del entorno" del propio SYL-N1). Presentada la disyuntiva al Director (construir T6 ya en modo híbrido, diseñar el modelo de entorno real de inmediato, o continuar T7–T8 y diferir T6), **el Director eligió continuar con T7–T8** (ambos Pyodide-nativos, sin esta dependencia) y diseñar el modelo de contenido de entorno real una sola vez, aplicándolo de forma consistente a T6 + M4 + M5 cuando corresponda. T6 permanece en su lugar correcto del temario (M1.T6) — solo su construcción se pospone. | SYL-N1 M1.T6; "Principio del entorno" |
| **EVT-030** | 2026-07-20 | Corrección / contradicción arquitectónica | **Mayor** | **Se detiene la reconstrucción de N1 al encontrar una contradicción real con el SYL-N1 v1.0.0 aprobado — una de las 4 condiciones de parada institucionales.** Un documento de lección construido en sesión previa ("N1.M1.T1 — Decoradores y closures") contradecía directamente la Herencia Declarada H-01 del propio SYL-N1, que excluye decoradores y closures de N1 **deliberadamente** ("aquí fallaba el 'por qué ahora'") y los reserva como primer tema de N2 (`N2.M1.T1`, ya correctamente instanciado en SYL-N2). El M1.T1 real de N1, según el syllabus aprobado, es **"Funciones a fondo"**. El Director resolvió: el SYL-N1 manda. Los documentos de investigación y lección de decoradores/closures se conservan íntegros (contenido real, con hallazgos genuinos) pero se reubican fuera de `docs/lecciones/n1/` a `docs/reservado-n2/`, marcados como semilla para cuando se construya N2. Ningún dato se descartó — el hallazgo se corrigió antes de construir un solo tema más sobre una base incorrecta. Se reafirma la validez del propio mecanismo de las 4 condiciones de parada: encontró exactamente el tipo de error que existe para atrapar. | SYL-N1; SYL-N2 H-01; docs/reservado-n2/ |
| **EVT-029** | 2026-07-19 | Contenido / cierre de nivel | **Mayor** | **N0 v2 — reconstrucción completa de las ocho lecciones (T1–T8) bajo DOC-11 v2.0.1 (Estándar de Excelencia Mundial), auditada y congelada como nueva versión de desarrollo.** Cada lección reconstruida con investigación real ampliada (quinta institución de referencia, UC Berkeley, añadida en todas; cuatro hallazgos nuevos genuinos: vocabulario "expresión" en T1, matiz honesto sobre el modelo de "caja" en T2 tras evidencia mixta real de Hermans & Swidan 2018, técnica de slicing por cortes en T5, convención `DEBUG:` en T8), siete capacidades de dominio explícitas por lección, laboratorios redefinidos como mini-proyectos que integran progresivamente T1 en adelante, desafíos finales inéditos, reflexión metacognitiva y Recursos recomendados. La Auditoría Integral v2 (`docs/informes/n0-auditoria-integral-v2.md`) encontró y corrigió un hallazgo real (cita incompleta de T2 en los laboratorios de T4-T7) antes del cierre. El Informe Final de Nivel v2 (`docs/informes/n0-informe-final-de-nivel.md`) documenta ocho hipótesis pendientes de validación (las cinco de v1 más tres nuevas, incluida la sostenibilidad real de la mayor densidad) y un riesgo nuevo (sobrecarga por densidad). **N0 v2 queda declarado por el Director como referente de calidad de toda la Academia y estándar de partida para todos los niveles futuros, incluido N1 en su propio cierre.** | DOC-11; N0 completo v2; informe final v2; auditoría v2 |
| **EVT-028** | 2026-07-19 | Documento / elevación de estándar | **Mayor** | **DOC-11 v2.0.0 — elevación institucional al Estándar de Excelencia Mundial; se ordena la reconstrucción completa de N0.** Directiva directa del Director: la referencia deja de ser "enseñar correctamente" y pasa a ser la exigencia, profundidad y densidad de los mejores cursos introductorios del mundo (MIT/CMU/Stanford/CS50/Berkeley/Oxford/Cambridge), sin copiar su contenido — solo prácticas verificadas que mejoran la Academia, y con la dificultad subiendo siempre por profundidad y práctica deliberada, nunca por artificio. Cambios estructurales de DOC-11: Bloque 5 redefinido como mini-proyecto que integra ≥2 lecciones previas y produce software funcional; Bloque 4 incorpora lectura de código y refactorización como categorías propias, y debugging como competencia con progresión (≥2 ejercicios); Bloque 6 incorpora reflexión metacognitiva y desafío final inédito; §4 redefinido en torno a siete capacidades de dominio (explicar/predecir/detectar errores/corregir/modificar/aplicar en contexto nuevo/usar en proyecto); nueva §4bis obligatoria de Recursos recomendados; sin límite implícito de extensión. Se aclara explícitamente que esta elevación no reabre la capa metodológica congelada en v1.5.0 (RISK-07): es una decisión del Director sobre el nivel de exigencia del contenido, no una recaída del autor en diseño de proceso. **Primer caso aplicado: N0·T1 "Tu primer programa" — su primera lección propia bajo DOC-11 (nunca la había tenido; solo vivía en producción), con investigación pedagógica real (hallazgo nuevo: Berkeley CS61A nombra "expresión" desde su primera clase; ajuste real: anatomía mínima de un error de Python enseñada antes de exigir su lectura, por hallazgo de Prather/Denny).** Reconstrucción de T2–T8 en curso. | DOC-11; N0·T1; 15.3 |
...
| Hitos registrados | 77 |
| — Mayores | 64 |
| — Menores | 13 |
| Primer hito | 2026-07-17 (EVT-001) |
| Último hito | 2026-07-21 (EVT-077: DOC-10 v1.0.3 — PATCH autorizado por el Director corrigiendo la carga estimada de N3 a ~4,6 meses) |
