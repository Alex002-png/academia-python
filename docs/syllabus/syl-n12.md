...
| **Versión / Estado** | **0.9.0** · Flujo institucional de 9 pasos: diseño (Paso 1) + M1-M5 completos (20 temas) + Capstone ET5 (Paso 4) + Paso 8 (compuertas + banco de examen) + Paso 9a (herencias finales, N12 confirmado hoja terminal) completos en `index.html`/`syl-n12.md` — **Auditoría Integral ejecutada (4 auditores independientes) y sus correcciones reales ya aplicadas** (redisño de M5 para cumplir su propia decisión de §3bis; cumplimiento DOC-12 §2.5/§2.8/§2.12 corregido en los 9 objetos de M3+M4; 8 `hints[0]` reescritos a conceptuales; consistent hashing añadido a M1.T3; cruce con DDIA declarado; repregunta cruzada añadida a la defensa del capstone). **Pendiente:** Auditoría Adversarial Final (Paso 9b) e Informe Final de Nivel antes de declarar "candidato a v1.0.0" — nunca autodeclarado (guía §12) |
