...
| **Versión / Estado** | **1.4.0** · ✅ **Aprobado** por el Director (2026-07-19) — **estándar oficial de autoría de todas las lecciones futuras de la Academia**, con el flujo completo de 7 fases (investigación → revisión crítica → ajustes → aprobación → redacción → validación → mejora continua) institucionalizado |
...
**Flujo definitivo de toda lección, desde este momento:** (1) Investigación pedagógica (§0bis) → (2) Revisión crítica de la investigación → (3) Ajustes derivados de la revisión → (4) Aprobación final de la investigación → (5) Redacción de la lección (Bloques 0–6) → (6) Validación con evidencia real (§6bis) → (7) Mejora continua (§6, §8bis de DOC-03).
