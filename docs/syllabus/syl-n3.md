...
| **Versión / Estado** | **0.9.0-draft** · Documento de Diseño + M1+M2+M3+M4 completos (24/24 temas) + Capstone ET3 + Paso 8 (compuertas + banco de examen) + Auditoría Integral completos — primer paso del flujo institucional de 9 pasos (DOC-03 §8bis / EVT-022), pendiente: Paso 9 (auditoría desde N4 + Herencias Declaradas finales), auditoría adversarial y v1.0.0 |
