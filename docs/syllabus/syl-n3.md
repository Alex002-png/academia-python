...
| **Versión / Estado** | **0.6.0-draft** · Documento de Diseño + M1+M2+M3+M4 completos (24/24 temas — TODO el contenido regular de N3 construido) — primer paso del flujo institucional de 9 pasos (DOC-03 §8bis / EVT-022), pendiente: capstone de nivel, compuertas, docs de investigación, auditoría integral, Herencias Declaradas finales, auditoría adversarial y v1.0.0 |
