...
| **Versión / Estado** | **1.0.0** · ✅ **Aprobado** por el Director (2026-07-18) — **plan de estudios oficial de la Academia** |
...
| Módulos | **M1 · Backend con FastAPI** (REST, validación, auth JWT/OAuth2; **concurrencia y asincronía**: async/await, hilos vs. procesos; **seguridad de aplicaciones**: OWASP Top 10, gestión de secretos, validación de entrada) · **M2 · Datos en producción** (PostgreSQL, Redis, migraciones) · **M3 · Calidad** (testing, TDD, clean code, patrones esenciales) · **M4 · Contenedores y CI/CD** (Docker, pipelines, despliegue, AWS básico) |
| Prerrequisitos locales | M1→M2; M3 transversal desde M1; M4 al final |
...
| Bibliografía oficial | 3Blue1Brown (esencia visual) · Mathematics for ML (Deisenroth) · Khan Academy como refuerzo |
| Carga estimada | ~3 meses · ~300 h |
