...
| **Versión / Estado** | **1.0.0-candidato** · Flujo institucional de 9 pasos completo (DOC-03 §8bis / EVT-022): diseño + M1-M4 (24/24 temas) + Capstone ET3 + Paso 8 (compuertas + banco de examen) + Auditoría Integral + Informe Final de Nivel + Paso 9 (coherencia desde N4 + Herencias Declaradas finales + auditoría adversarial) completos — **candidato a v1.0.0 con 2 reservas nombradas y acotadas** (patrón de pistas que regalan la solución; ausencia de ruta de renderizado para los 5 estándares narrativos), **pendiente del veredicto definitivo del Director**, no autodeclarado |
