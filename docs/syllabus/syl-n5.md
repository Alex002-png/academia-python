...
| **Versión / Estado** | **0.3.0** · Paso 1 (diseño) + **M1 · Redes desde cero** + **M2 · PyTorch completos** (M1: 4 temas/12 días/56 ejercicios Pyodide; M2: 4 laboratorios DOC-12 en Google Colab) — pendiente M3-M4, capstone, compuertas, auditorías y v1.0.0-candidato |
