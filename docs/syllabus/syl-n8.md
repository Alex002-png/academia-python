...
| **Versión / Estado** | **0.6.0-candidato a v1.0.0, sin reservas bloqueantes** · Flujo institucional de 9 pasos completo (Pasos 1-9b) — investigación real verificada, decisiones de arquitectura documentadas, M1-M5 construidos en `LEVEL8` (22 laboratorios DOC-12), proyecto de nivel, compuertas, auditoría integral (4 auditores, 8 correcciones), Herencias Declaradas hacia N9, auditoría adversarial (2 revisores, 5 correcciones), Informe Final de Nivel (`docs/informes/n8-informe-final-de-nivel.md`). **Las 2 reservas del Paso 9b resueltas por instrucción directa del Director (2026-07-22)**: (1) carga estimada corregida vía PATCH administrativo DOC-10 1.0.4 (de "~5 meses·~500h" a "~6-7 semanas·~170h", verificado por suma real de los 22 `duracionTotal`) — el Director instruyó explícitamente no inflar la cifra para sostener una expectativa histórica; (2) verificación empírica real de 8/22 `errorVivo` (36%, concentrados en M4) queda **registrada como limitación conocida, transparente, no bloqueante** — el Director prefirió explícitamente una limitación declarada a una verificación ficticia, con la comprobación real diferida al entorno definitivo. **Ninguna reserva bloquea la congelación del nivel — decisión explícita del Director.** |
