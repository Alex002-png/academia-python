...
| **Versión / Estado** | **0.3.0-draft** · Documento de Diseño + M1 completo (7 temas) — primer paso del flujo institucional de 9 pasos (DOC-03 §8bis / EVT-022), pendiente de revisión módulo por módulo con el Director antes de v1.0.0 |
