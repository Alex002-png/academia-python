...
| **Versión / Estado** | **1.6.0** · ✅ **Aprobado** por el Director (2026-07-19) — **estándar oficial de autoría de todas las lecciones futuras de la Academia**. Flujo de 7 fases + principio de falsabilidad pedagógica. **El proceso queda congelado desde esta versión**: no se añadirán nuevas capas metodológicas salvo que la evidencia acumulada de decenas de lecciones y validaciones lo justifique — la prioridad pasa a construir contenido |
