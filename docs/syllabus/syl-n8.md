...
| **Versión / Estado** | **0.3.0-draft** · Pasos 1-2-4-5 del flujo institucional de 9 pasos completos — investigación real verificada, decisiones de arquitectura documentadas, M1-M5 construidos en `LEVEL8` (22 laboratorios DOC-12), proyecto de nivel construido (`n8proyecto`), compuertas diseñadas (cobertura de competencias + banco de examen de 24 variantes). Pendiente: auditoría integral, auditoría de coherencia desde N9 + Herencias Declaradas finales (Paso 9a), auditoría adversarial (Paso 9b), Informe Final de Nivel, v1.0.0 |
...
Revisión del Director sobre este diseño de syllabus (arquitectura de plataforma, agnosticismo de proveedor, 22 temas de M1-M5, proyecto de nivel, compuertas) — mismo checkpoint que ya se usó para aprobar la dirección arquitectónica. Tras la aprobación (o los ajustes que correspondan), Paso 6 del flujo institucional: auditoría integral (múltiples auditores independientes), auditoría de coherencia desde N9 + Herencias Declaradas finales, auditoría adversarial (Paso 9b), e Informe Final de Nivel.
