...
| **Versión / Estado** | **1.3.0** · ✅ **Aprobado** por el Director (2026-07-19) — **estándar oficial de autoría de todas las lecciones futuras de la Academia**, con el registro de observaciones (§6), los tres estados independientes (§6bis) y los cinco principios permanentes de la investigación pedagógica (§0bis) institucionalizados |
