...
| **Versión / Estado** | **0.4.0-draft** · Documento de Diseño + M1 + M2 completos (13 temas) — primer paso del flujo institucional de 9 pasos (DOC-03 §8bis / EVT-022), pendiente de revisión módulo por módulo con el Director antes de v1.0.0 |
