...
| C-N2-05 (justifica decisiones técnicas) | Presente en T4 de cada módulo (M1, M2, M4, M5) + defensa del capstone |
| C-N2-06 (lee documentación oficial en inglés) | Distribuida en fichas de M1-M5 (FastAPI, Docker, PostgreSQL docs) |
